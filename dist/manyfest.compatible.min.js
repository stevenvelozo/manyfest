!function(t){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=t();else if("function"==typeof define&&define.amd)define([],t);else{("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).Manyfest=t()}}((function(){return function t(e,n,r){function s(a,o){if(!n[a]){if(!e[a]){var u="function"==typeof require&&require;if(!o&&u)return u(a,!0);if(i)return i(a,!0);var p=new Error("Cannot find module '"+a+"'");throw p.code="MODULE_NOT_FOUND",p}var l=n[a]={exports:{}};e[a][0].call(l.exports,(function(t){return s(e[a][1][t]||t)}),l,l.exports,t,e,n,r)}return n[a].exports}for(var i="function"==typeof require&&require,a=0;a<r.length;a++)s(r[a]);return s}({1:[function(t,e,n){!function(t){"use strict";
/*!
         *  decimal.js v10.4.3
         ...
         *  MIT Licence
         */var n,r,s,i,a=9e15,o=1e9,u="0123456789abcdef",p="2.",l="3.",c={precision:20,rounding:4,modulo:1,toExpNeg:-7,toExpPos:21,minE:-a,maxE:a,crypto:!1},h=!0,d="[DecimalError] ",f=d+"Invalid argument: ",g=d+"Precision limit exceeded",y=d+"crypto unavailable",O="[object Decimal]",m=Math.floor,b=Math.pow,S=/^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i,N=/^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i,I=/^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i,w=/^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i,j=1e7,M=7,v=p.length-1,A=l.length-1,P={toStringTag:O};function x(t){var e,n,r,s=t.length-1,i="",a=t[0];if(s>0){for(i+=a,e=1;e<s;e++)r=t[e]+"",(n=M-r.length)&&(i+=k(n)),i+=r;a=t[e],(n=M-(r=a+"").length)&&(i+=k(n))}else if(0===a)return"0";for(;a%10==0;)a/=10;return i+a}function D(t,e,n){if(t!==~~t||t<e||t>n)throw Error(f+t)}function H(t,e,n,r){var s,i,a,o;for(i=t[0];i>=10;i/=10)--e;return--e<0?(e+=M,s=0):(s=Math.ceil((e+1)/M),e%=M),i=b(10,M-e),o=t[s]%i|0,null==r?e<3?(0==e?o=o/100|0:1==e&&(o=o/10|0),a=n<4&&99999==o||n>3&&49999==o||5e4==o||0==o):a=(n<4&&o+1==i||n>3&&o+1==i/2)&&(t[s+1]/i/100|0)==b(10,e-2)-1||(o==i/2||0==o)&&0==(t[s+1]/i/100|0):e<4?(0==e?o=o/1e3|0:1==e?o=o/100|0:2==e&&(o=o/10|0),a=(r||n<4)&&9999==o||!r&&n>3&&4999==o):a=((r||n<4)&&o+1==i||!r&&n>3&&o+1==i/2)&&(t[s+1]/i/1e3|0)==b(10,e-3)-1,a}function V(t,e,n){for(var r,s,i=[0],a=0,o=t.length;a<o;){for(s=i.length;s--;)i[s]*=e;for(i[0]+=u.indexOf(t.charAt(a++)),r=0;r<i.length;r++)i[r]>n-1&&(void 0===i[r+1]&&(i[r+1]=0),i[r+1]+=i[r]/n|0,i[r]%=n)}return i.reverse()}P.absoluteValue=P.abs=function(){var t=new this.constructor(this);return t.s<0&&(t.s=1),T(t)},P.ceil=function(){return T(new this.constructor(this),this.e+1,2)},P.clampedTo=P.clamp=function(t,e){var n=this,r=n.constructor;if(t=new r(t),e=new r(e),!t.s||!e.s)return new r(NaN);if(t.gt(e))throw Error(f+e);return n.cmp(t)<0?t:n.cmp(e)>0?e:new r(n)},P.comparedTo=P.cmp=function(t){var e,n,r,s,i=this,a=i.d,o=(t=new i.constructor(t)).d,u=i.s,p=t.s;if(!a||!o)return u&&p?u!==p?u:a===o?0:!a^u<0?1:-1:NaN;if(!a[0]||!o[0])return a[0]?u:o[0]?-p:0;if(u!==p)return u;if(i.e!==t.e)return i.e>t.e^u<0?1:-1;for(e=0,n=(r=a.length)<(s=o.length)?r:s;e<n;++e)if(a[e]!==o[e])return a[e]>o[e]^u<0?1:-1;return r===s?0:r>s^u<0?1:-1},P.cosine=P.cos=function(){var t,e,n=this,r=n.constructor;return n.d?n.d[0]?(t=r.precision,e=r.rounding,r.precision=t+Math.max(n.e,n.sd())+M,r.rounding=1,n=function(t,e){var n,r,s;if(e.isZero())return e;r=e.d.length,r<32?s=(1/Q(4,n=Math.ceil(r/3))).toString():(n=16,s="2.3283064365386962890625e-10");t.precision+=n,e=Z(t,1,e.times(s),new t(1));for(var i=n;i--;){var a=e.times(e);e=a.times(a).minus(a).times(8).plus(1)}return t.precision-=n,e}(r,K(r,n)),r.precision=t,r.rounding=e,T(2==i||3==i?n.neg():n,t,e,!0)):new r(1):new r(NaN)},P.cubeRoot=P.cbrt=function(){var t,e,n,r,s,i,a,o,u,p,l=this,c=l.constructor;if(!l.isFinite()||l.isZero())return new c(l);for(h=!1,(i=l.s*b(l.s*l,1/3))&&Math.abs(i)!=1/0?r=new c(i.toString()):(n=x(l.d),(i=((t=l.e)-n.length+1)%3)&&(n+=1==i||-2==i?"0":"00"),i=b(n,1/3),t=m((t+1)/3)-(t%3==(t<0?-1:2)),(r=new c(n=i==1/0?"5e"+t:(n=i.toExponential()).slice(0,n.indexOf("e")+1)+t)).s=l.s),a=(t=c.precision)+3;;)if(p=(u=(o=r).times(o).times(o)).plus(l),r=E(p.plus(l).times(o),p.plus(u),a+2,1),x(o.d).slice(0,a)===(n=x(r.d)).slice(0,a)){if("9999"!=(n=n.slice(a-3,a+1))&&(s||"4999"!=n)){+n&&(+n.slice(1)||"5"!=n.charAt(0))||(T(r,t+1,1),e=!r.times(r).times(r).eq(l));break}if(!s&&(T(o,t+1,0),o.times(o).times(o).eq(l))){r=o;break}a+=4,s=1}return h=!0,T(r,t,c.rounding,e)},P.decimalPlaces=P.dp=function(){var t,e=this.d,n=NaN;if(e){if(n=((t=e.length-1)-m(this.e/M))*M,t=e[t])for(;t%10==0;t/=10)n--;n<0&&(n=0)}return n},P.dividedBy=P.div=function(t){return E(this,new this.constructor(t))},P.dividedToIntegerBy=P.divToInt=function(t){var e=this.constructor;return T(E(this,new e(t),0,1,1),e.precision,e.rounding)},P.equals=P.eq=function(t){return 0===this.cmp(t)},P.floor=function(){return T(new this.constructor(this),this.e+1,3)},P.greaterThan=P.gt=function(t){return this.cmp(t)>0},P.greaterThanOrEqualTo=P.gte=function(t){var e=this.cmp(t);return 1==e||0===e},P.hyperbolicCosine=P.cosh=function(){var t,e,n,r,s,i=this,a=i.constructor,o=new a(1);if(!i.isFinite())return new a(i.s?1/0:NaN);if(i.isZero())return o;n=a.precision,r=a.rounding,a.precision=n+Math.max(i.e,i.sd())+4,a.rounding=1,(s=i.d.length)<32?e=(1/Q(4,t=Math.ceil(s/3))).toString():(t=16,e="2.3283064365386962890625e-10"),i=Z(a,1,i.times(e),new a(1),!0);for(var u,p=t,l=new a(8);p--;)u=i.times(i),i=o.minus(u.times(l.minus(u.times(l))));return T(i,a.precision=n,a.rounding=r,!0)},P.hyperbolicSine=P.sinh=function(){var t,e,n,r,s=this,i=s.constructor;if(!s.isFinite()||s.isZero())return new i(s);if(e=i.precision,n=i.rounding,i.precision=e+Math.max(s.e,s.sd())+4,i.rounding=1,(r=s.d.length)<3)s=Z(i,2,s,s,!0);else{t=(t=1.4*Math.sqrt(r))>16?16:0|t,s=Z(i,2,s=s.times(1/Q(5,t)),s,!0);for(var a,o=new i(5),u=new i(16),p=new i(20);t--;)a=s.times(s),s=s.times(o.plus(a.times(u.times(a).plus(p))))}return i.precision=e,i.rounding=n,T(s,e,n,!0)},P.hyperbolicTangent=P.tanh=function(){var t,e,n=this,r=n.constructor;return n.isFinite()?n.isZero()?new r(n):(t=r.precision,e=r.rounding,r.precision=t+7,r.rounding=1,E(n.sinh(),n.cosh(),r.precision=t,r.rounding=e)):new r(n.s)},P.inverseCosine=P.acos=function(){var t,e=this,n=e.constructor,r=e.abs().cmp(1),s=n.precision,i=n.rounding;return-1!==r?0===r?e.isNeg()?C(n,s,i):new n(0):new n(NaN):e.isZero()?C(n,s+4,i).times(.5):(n.precision=s+6,n.rounding=1,e=e.asin(),t=C(n,s+4,i).times(.5),n.precision=s,n.rounding=i,t.minus(e))},P.inverseHyperbolicCosine=P.acosh=function(){var t,e,n=this,r=n.constructor;return n.lte(1)?new r(n.eq(1)?0:NaN):n.isFinite()?(t=r.precision,e=r.rounding,r.precision=t+Math.max(Math.abs(n.e),n.sd())+4,r.rounding=1,h=!1,n=n.times(n).minus(1).sqrt().plus(n),h=!0,r.precision=t,r.rounding=e,n.ln()):new r(n)},P.inverseHyperbolicSine=P.asinh=function(){var t,e,n=this,r=n.constructor;return!n.isFinite()||n.isZero()?new r(n):(t=r.precision,e=r.rounding,r.precision=t+2*Math.max(Math.abs(n.e),n.sd())+6,r.rounding=1,h=!1,n=n.times(n).plus(1).sqrt().plus(n),h=!0,r.precision=t,r.rounding=e,n.ln())},P.inverseHyperbolicTangent=P.atanh=function(){var t,e,n,r,s=this,i=s.constructor;return s.isFinite()?s.e>=0?new i(s.abs().eq(1)?s.s/0:s.isZero()?s:NaN):(t=i.precision,e=i.rounding,r=s.sd(),Math.max(r,t)<2*-s.e-1?T(new i(s),t,e,!0):(i.precision=n=r-s.e,s=E(s.plus(1),new i(1).minus(s),n+t,1),i.precision=t+4,i.rounding=1,s=s.ln(),i.precision=t,i.rounding=e,s.times(.5))):new i(NaN)},P.inverseSine=P.asin=function(){var t,e,n,r,s=this,i=s.constructor;return s.isZero()?new i(s):(e=s.abs().cmp(1),n=i.precision,r=i.rounding,-1!==e?0===e?((t=C(i,n+4,r).times(.5)).s=s.s,t):new i(NaN):(i.precision=n+6,i.rounding=1,s=s.div(new i(1).minus(s.times(s)).sqrt().plus(1)).atan(),i.precision=n,i.rounding=r,s.times(2)))},P.inverseTangent=P.atan=function(){var t,e,n,r,s,i,a,o,u,p=this,l=p.constructor,c=l.precision,d=l.rounding;if(p.isFinite()){if(p.isZero())return new l(p);if(p.abs().eq(1)&&c+4<=A)return(a=C(l,c+4,d).times(.25)).s=p.s,a}else{if(!p.s)return new l(NaN);if(c+4<=A)return(a=C(l,c+4,d).times(.5)).s=p.s,a}for(l.precision=o=c+10,l.rounding=1,t=n=Math.min(28,o/M+2|0);t;--t)p=p.div(p.times(p).plus(1).sqrt().plus(1));for(h=!1,e=Math.ceil(o/M),r=1,u=p.times(p),a=new l(p),s=p;-1!==t;)if(s=s.times(u),i=a.minus(s.div(r+=2)),s=s.times(u),void 0!==(a=i.plus(s.div(r+=2))).d[e])for(t=e;a.d[t]===i.d[t]&&t--;);return n&&(a=a.times(2<<n-1)),h=!0,T(a,l.precision=c,l.rounding=d,!0)},P.isFinite=function(){return!!this.d},P.isInteger=P.isInt=function(){return!!this.d&&m(this.e/M)>this.d.length-2},P.isNaN=function(){return!this.s},P.isNegative=P.isNeg=function(){return this.s<0},P.isPositive=P.isPos=function(){return this.s>0},P.isZero=function(){return!!this.d&&0===this.d[0]},P.lessThan=P.lt=function(t){return this.cmp(t)<0},P.lessThanOrEqualTo=P.lte=function(t){return this.cmp(t)<1},P.logarithm=P.log=function(t){var e,n,r,s,i,a,o,u,p=this,l=p.constructor,c=l.precision,d=l.rounding;if(null==t)t=new l(10),e=!0;else{if(n=(t=new l(t)).d,t.s<0||!n||!n[0]||t.eq(1))return new l(NaN);e=t.eq(10)}if(n=p.d,p.s<0||!n||!n[0]||p.eq(1))return new l(n&&!n[0]?-1/0:1!=p.s?NaN:n?0:1/0);if(e)if(n.length>1)i=!0;else{for(s=n[0];s%10==0;)s/=10;i=1!==s}if(h=!1,a=q(p,o=c+5),r=e?L(l,o+10):q(t,o),H((u=E(a,r,o,1)).d,s=c,d))do{if(a=q(p,o+=10),r=e?L(l,o+10):q(t,o),u=E(a,r,o,1),!i){+x(u.d).slice(s+1,s+15)+1==1e14&&(u=T(u,c+1,0));break}}while(H(u.d,s+=10,d));return h=!0,T(u,c,d)},P.minus=P.sub=function(t){var e,n,r,s,i,a,o,u,p,l,c,d,f=this,g=f.constructor;if(t=new g(t),!f.d||!t.d)return f.s&&t.s?f.d?t.s=-t.s:t=new g(t.d||f.s!==t.s?f:NaN):t=new g(NaN),t;if(f.s!=t.s)return t.s=-t.s,f.plus(t);if(p=f.d,d=t.d,o=g.precision,u=g.rounding,!p[0]||!d[0]){if(d[0])t.s=-t.s;else{if(!p[0])return new g(3===u?-0:0);t=new g(f)}return h?T(t,o,u):t}if(n=m(t.e/M),l=m(f.e/M),p=p.slice(),i=l-n){for((c=i<0)?(e=p,i=-i,a=d.length):(e=d,n=l,a=p.length),i>(r=Math.max(Math.ceil(o/M),a)+2)&&(i=r,e.length=1),e.reverse(),r=i;r--;)e.push(0);e.reverse()}else{for((c=(r=p.length)<(a=d.length))&&(a=r),r=0;r<a;r++)if(p[r]!=d[r]){c=p[r]<d[r];break}i=0}for(c&&(e=p,p=d,d=e,t.s=-t.s),a=p.length,r=d.length-a;r>0;--r)p[a++]=0;for(r=d.length;r>i;){if(p[--r]<d[r]){for(s=r;s&&0===p[--s];)p[s]=j-1;--p[s],p[r]+=j}p[r]-=d[r]}for(;0===p[--a];)p.pop();for(;0===p[0];p.shift())--n;return p[0]?(t.d=p,t.e=_(p,n),h?T(t,o,u):t):new g(3===u?-0:0)},P.modulo=P.mod=function(t){var e,n=this,r=n.constructor;return t=new r(t),!n.d||!t.s||t.d&&!t.d[0]?new r(NaN):!t.d||n.d&&!n.d[0]?T(new r(n),r.precision,r.rounding):(h=!1,9==r.modulo?(e=E(n,t.abs(),0,3,1)).s*=t.s:e=E(n,t,0,r.modulo,1),e=e.times(t),h=!0,n.minus(e))},P.naturalExponential=P.exp=function(){return F(this)},P.naturalLogarithm=P.ln=function(){return q(this)},P.negated=P.neg=function(){var t=new this.constructor(this);return t.s=-t.s,T(t)},P.plus=P.add=function(t){var e,n,r,s,i,a,o,u,p,l,c=this,d=c.constructor;if(t=new d(t),!c.d||!t.d)return c.s&&t.s?c.d||(t=new d(t.d||c.s===t.s?c:NaN)):t=new d(NaN),t;if(c.s!=t.s)return t.s=-t.s,c.minus(t);if(p=c.d,l=t.d,o=d.precision,u=d.rounding,!p[0]||!l[0])return l[0]||(t=new d(c)),h?T(t,o,u):t;if(i=m(c.e/M),r=m(t.e/M),p=p.slice(),s=i-r){for(s<0?(n=p,s=-s,a=l.length):(n=l,r=i,a=p.length),s>(a=(i=Math.ceil(o/M))>a?i+1:a+1)&&(s=a,n.length=1),n.reverse();s--;)n.push(0);n.reverse()}for((a=p.length)-(s=l.length)<0&&(s=a,n=l,l=p,p=n),e=0;s;)e=(p[--s]=p[s]+l[s]+e)/j|0,p[s]%=j;for(e&&(p.unshift(e),++r),a=p.length;0==p[--a];)p.pop();return t.d=p,t.e=_(p,r),h?T(t,o,u):t},P.precision=P.sd=function(t){var e,n=this;if(void 0!==t&&t!==!!t&&1!==t&&0!==t)throw Error(f+t);return n.d?(e=R(n.d),t&&n.e+1>e&&(e=n.e+1)):e=NaN,e},P.round=function(){var t=this,e=t.constructor;return T(new e(t),t.e+1,e.rounding)},P.sine=P.sin=function(){var t,e,n=this,r=n.constructor;return n.isFinite()?n.isZero()?new r(n):(t=r.precision,e=r.rounding,r.precision=t+Math.max(n.e,n.sd())+M,r.rounding=1,n=function(t,e){var n,r=e.d.length;if(r<3)return e.isZero()?e:Z(t,2,e,e);n=(n=1.4*Math.sqrt(r))>16?16:0|n,e=e.times(1/Q(5,n)),e=Z(t,2,e,e);for(var s,i=new t(5),a=new t(16),o=new t(20);n--;)s=e.times(e),e=e.times(i.plus(s.times(a.times(s).minus(o))));return e}(r,K(r,n)),r.precision=t,r.rounding=e,T(i>2?n.neg():n,t,e,!0)):new r(NaN)},P.squareRoot=P.sqrt=function(){var t,e,n,r,s,i,a=this,o=a.d,u=a.e,p=a.s,l=a.constructor;if(1!==p||!o||!o[0])return new l(!p||p<0&&(!o||o[0])?NaN:o?a:1/0);for(h=!1,0==(p=Math.sqrt(+a))||p==1/0?(((e=x(o)).length+u)%2==0&&(e+="0"),p=Math.sqrt(e),u=m((u+1)/2)-(u<0||u%2),r=new l(e=p==1/0?"5e"+u:(e=p.toExponential()).slice(0,e.indexOf("e")+1)+u)):r=new l(p.toString()),n=(u=l.precision)+3;;)if(r=(i=r).plus(E(a,i,n+2,1)).times(.5),x(i.d).slice(0,n)===(e=x(r.d)).slice(0,n)){if("9999"!=(e=e.slice(n-3,n+1))&&(s||"4999"!=e)){+e&&(+e.slice(1)||"5"!=e.charAt(0))||(T(r,u+1,1),t=!r.times(r).eq(a));break}if(!s&&(T(i,u+1,0),i.times(i).eq(a))){r=i;break}n+=4,s=1}return h=!0,T(r,u,l.rounding,t)},P.tangent=P.tan=function(){var t,e,n=this,r=n.constructor;return n.isFinite()?n.isZero()?new r(n):(t=r.precision,e=r.rounding,r.precision=t+10,r.rounding=1,(n=n.sin()).s=1,n=E(n,new r(1).minus(n.times(n)).sqrt(),t+10,0),r.precision=t,r.rounding=e,T(2==i||4==i?n.neg():n,t,e,!0)):new r(NaN)},P.times=P.mul=function(t){var e,n,r,s,i,a,o,u,p,l=this,c=l.constructor,d=l.d,f=(t=new c(t)).d;if(t.s*=l.s,!(d&&d[0]&&f&&f[0]))return new c(!t.s||d&&!d[0]&&!f||f&&!f[0]&&!d?NaN:d&&f?0*t.s:t.s/0);for(n=m(l.e/M)+m(t.e/M),(u=d.length)<(p=f.length)&&(i=d,d=f,f=i,a=u,u=p,p=a),i=[],r=a=u+p;r--;)i.push(0);for(r=p;--r>=0;){for(e=0,s=u+r;s>r;)o=i[s]+f[r]*d[s-r-1]+e,i[s--]=o%j|0,e=o/j|0;i[s]=(i[s]+e)%j|0}for(;!i[--a];)i.pop();return e?++n:i.shift(),t.d=i,t.e=_(i,n),h?T(t,c.precision,c.rounding):t},P.toBinary=function(t,e){return X(this,2,t,e)},P.toDecimalPlaces=P.toDP=function(t,e){var n=this,r=n.constructor;return n=new r(n),void 0===t?n:(D(t,0,o),void 0===e?e=r.rounding:D(e,0,8),T(n,t+n.e+1,e))},P.toExponential=function(t,e){var n,r=this,s=r.constructor;return void 0===t?n=$(r,!0):(D(t,0,o),void 0===e?e=s.rounding:D(e,0,8),n=$(r=T(new s(r),t+1,e),!0,t+1)),r.isNeg()&&!r.isZero()?"-"+n:n},P.toFixed=function(t,e){var n,r,s=this,i=s.constructor;return void 0===t?n=$(s):(D(t,0,o),void 0===e?e=i.rounding:D(e,0,8),n=$(r=T(new i(s),t+s.e+1,e),!1,t+r.e+1)),s.isNeg()&&!s.isZero()?"-"+n:n},P.toFraction=function(t){var e,n,r,s,i,a,o,u,p,l,c,d,g=this,y=g.d,O=g.constructor;if(!y)return new O(g);if(p=n=new O(1),r=u=new O(0),a=(i=(e=new O(r)).e=R(y)-g.e-1)%M,e.d[0]=b(10,a<0?M+a:a),null==t)t=i>0?e:p;else{if(!(o=new O(t)).isInt()||o.lt(p))throw Error(f+o);t=o.gt(e)?i>0?e:p:o}for(h=!1,o=new O(x(y)),l=O.precision,O.precision=i=y.length*M*2;c=E(o,e,0,1,1),1!=(s=n.plus(c.times(r))).cmp(t);)n=r,r=s,s=p,p=u.plus(c.times(s)),u=s,s=e,e=o.minus(c.times(s)),o=s;return s=E(t.minus(n),r,0,1,1),u=u.plus(s.times(p)),n=n.plus(s.times(r)),u.s=p.s=g.s,d=E(p,r,i,1).minus(g).abs().cmp(E(u,n,i,1).minus(g).abs())<1?[p,r]:[u,n],O.precision=l,h=!0,d},P.toHexadecimal=P.toHex=function(t,e){return X(this,16,t,e)},P.toNearest=function(t,e){var n=this,r=n.constructor;if(n=new r(n),null==t){if(!n.d)return n;t=new r(1),e=r.rounding}else{if(t=new r(t),void 0===e?e=r.rounding:D(e,0,8),!n.d)return t.s?n:t;if(!t.d)return t.s&&(t.s=n.s),t}return t.d[0]?(h=!1,n=E(n,t,0,e,1).times(t),h=!0,T(n)):(t.s=n.s,n=t),n},P.toNumber=function(){return+this},P.toOctal=function(t,e){return X(this,8,t,e)},P.toPower=P.pow=function(t){var e,n,r,s,i,a,o=this,u=o.constructor,p=+(t=new u(t));if(!(o.d&&t.d&&o.d[0]&&t.d[0]))return new u(b(+o,p));if((o=new u(o)).eq(1))return o;if(r=u.precision,i=u.rounding,t.eq(1))return T(o,r,i);if((e=m(t.e/M))>=t.d.length-1&&(n=p<0?-p:p)<=9007199254740991)return s=B(u,o,n,r),t.s<0?new u(1).div(s):T(s,r,i);if((a=o.s)<0){if(e<t.d.length-1)return new u(NaN);if(0==(1&t.d[e])&&(a=1),0==o.e&&1==o.d[0]&&1==o.d.length)return o.s=a,o}return(e=0!=(n=b(+o,p))&&isFinite(n)?new u(n+"").e:m(p*(Math.log("0."+x(o.d))/Math.LN10+o.e+1)))>u.maxE+1||e<u.minE-1?new u(e>0?a/0:0):(h=!1,u.rounding=o.s=1,n=Math.min(12,(e+"").length),(s=F(t.times(q(o,r+n)),r)).d&&H((s=T(s,r+5,1)).d,r,i)&&(e=r+10,+x((s=T(F(t.times(q(o,e+n)),e),e+5,1)).d).slice(r+1,r+15)+1==1e14&&(s=T(s,r+1,0))),s.s=a,h=!0,u.rounding=i,T(s,r,i))},P.toPrecision=function(t,e){var n,r=this,s=r.constructor;return void 0===t?n=$(r,r.e<=s.toExpNeg||r.e>=s.toExpPos):(D(t,1,o),void 0===e?e=s.rounding:D(e,0,8),n=$(r=T(new s(r),t,e),t<=r.e||r.e<=s.toExpNeg,t)),r.isNeg()&&!r.isZero()?"-"+n:n},P.toSignificantDigits=P.toSD=function(t,e){var n=this.constructor;return void 0===t?(t=n.precision,e=n.rounding):(D(t,1,o),void 0===e?e=n.rounding:D(e,0,8)),T(new n(this),t,e)},P.toString=function(){var t=this,e=t.constructor,n=$(t,t.e<=e.toExpNeg||t.e>=e.toExpPos);return t.isNeg()&&!t.isZero()?"-"+n:n},P.truncated=P.trunc=function(){return T(new this.constructor(this),this.e+1,1)},P.valueOf=P.toJSON=function(){var t=this,e=t.constructor,n=$(t,t.e<=e.toExpNeg||t.e>=e.toExpPos);return t.isNeg()?"-"+n:n};var E=function(){function t(t,e,n){var r,s=0,i=t.length;for(t=t.slice();i--;)r=t[i]*e+s,t[i]=r%n|0,s=r/n|0;return s&&t.unshift(s),t}function e(t,e,n,r){var s,i;if(n!=r)i=n>r?1:-1;else for(s=i=0;s<n;s++)if(t[s]!=e[s]){i=t[s]>e[s]?1:-1;break}return i}function n(t,e,n,r){for(var s=0;n--;)t[n]-=s,s=t[n]<e[n]?1:0,t[n]=s*r+t[n]-e[n];for(;!t[0]&&t.length>1;)t.shift()}return function(s,i,a,o,u,p){var l,c,h,d,f,g,y,O,b,S,N,I,w,v,A,P,x,D,H,V,E=s.constructor,$=s.s==i.s?1:-1,_=s.d,L=i.d;if(!(_&&_[0]&&L&&L[0]))return new E(s.s&&i.s&&(_?!L||_[0]!=L[0]:L)?_&&0==_[0]||!L?0*$:$/0:NaN);for(p?(f=1,c=s.e-i.e):(p=j,f=M,c=m(s.e/f)-m(i.e/f)),H=L.length,x=_.length,S=(b=new E($)).d=[],h=0;L[h]==(_[h]||0);h++);if(L[h]>(_[h]||0)&&c--,null==a?(v=a=E.precision,o=E.rounding):v=u?a+(s.e-i.e)+1:a,v<0)S.push(1),g=!0;else{if(v=v/f+2|0,h=0,1==H){for(d=0,L=L[0],v++;(h<x||d)&&v--;h++)A=d*p+(_[h]||0),S[h]=A/L|0,d=A%L|0;g=d||h<x}else{for((d=p/(L[0]+1)|0)>1&&(L=t(L,d,p),_=t(_,d,p),H=L.length,x=_.length),P=H,I=(N=_.slice(0,H)).length;I<H;)N[I++]=0;(V=L.slice()).unshift(0),D=L[0],L[1]>=p/2&&++D;do{d=0,(l=e(L,N,H,I))<0?(w=N[0],H!=I&&(w=w*p+(N[1]||0)),(d=w/D|0)>1?(d>=p&&(d=p-1),1==(l=e(y=t(L,d,p),N,O=y.length,I=N.length))&&(d--,n(y,H<O?V:L,O,p))):(0==d&&(l=d=1),y=L.slice()),(O=y.length)<I&&y.unshift(0),n(N,y,I,p),-1==l&&(l=e(L,N,H,I=N.length))<1&&(d++,n(N,H<I?V:L,I,p)),I=N.length):0===l&&(d++,N=[0]),S[h++]=d,l&&N[0]?N[I++]=_[P]||0:(N=[_[P]],I=1)}while((P++<x||void 0!==N[0])&&v--);g=void 0!==N[0]}S[0]||S.shift()}if(1==f)b.e=c,r=g;else{for(h=1,d=S[0];d>=10;d/=10)h++;b.e=h+c*f-1,T(b,u?a+b.e+1:a,o,g)}return b}}();function T(t,e,n,r){var s,i,a,o,u,p,l,c,d,f=t.constructor;t:if(null!=e){if(!(c=t.d))return t;for(s=1,o=c[0];o>=10;o/=10)s++;if((i=e-s)<0)i+=M,a=e,u=(l=c[d=0])/b(10,s-a-1)%10|0;else if((d=Math.ceil((i+1)/M))>=(o=c.length)){if(!r)break t;for(;o++<=d;)c.push(0);l=u=0,s=1,a=(i%=M)-M+1}else{for(l=o=c[d],s=1;o>=10;o/=10)s++;u=(a=(i%=M)-M+s)<0?0:l/b(10,s-a-1)%10|0}if(r=r||e<0||void 0!==c[d+1]||(a<0?l:l%b(10,s-a-1)),p=n<4?(u||r)&&(0==n||n==(t.s<0?3:2)):u>5||5==u&&(4==n||r||6==n&&(i>0?a>0?l/b(10,s-a):0:c[d-1])%10&1||n==(t.s<0?8:7)),e<1||!c[0])return c.length=0,p?(e-=t.e+1,c[0]=b(10,(M-e%M)%M),t.e=-e||0):c[0]=t.e=0,t;if(0==i?(c.length=d,o=1,d--):(c.length=d+1,o=b(10,M-i),c[d]=a>0?(l/b(10,s-a)%b(10,a)|0)*o:0),p)for(;;){if(0==d){for(i=1,a=c[0];a>=10;a/=10)i++;for(a=c[0]+=o,o=1;a>=10;a/=10)o++;i!=o&&(t.e++,c[0]==j&&(c[0]=1));break}if(c[d]+=o,c[d]!=j)break;c[d--]=0,o=1}for(i=c.length;0===c[--i];)c.pop()}return h&&(t.e>f.maxE?(t.d=null,t.e=NaN):t.e<f.minE&&(t.e=0,t.d=[0])),t}function $(t,e,n){if(!t.isFinite())return G(t);var r,s=t.e,i=x(t.d),a=i.length;return e?(n&&(r=n-a)>0?i=i.charAt(0)+"."+i.slice(1)+k(r):a>1&&(i=i.charAt(0)+"."+i.slice(1)),i=i+(t.e<0?"e":"e+")+t.e):s<0?(i="0."+k(-s-1)+i,n&&(r=n-a)>0&&(i+=k(r))):s>=a?(i+=k(s+1-a),n&&(r=n-s-1)>0&&(i=i+"."+k(r))):((r=s+1)<a&&(i=i.slice(0,r)+"."+i.slice(r)),n&&(r=n-a)>0&&(s+1===a&&(i+="."),i+=k(r))),i}function _(t,e){var n=t[0];for(e*=M;n>=10;n/=10)e++;return e}function L(t,e,n){if(e>v)throw h=!0,n&&(t.precision=n),Error(g);return T(new t(p),e,1,!0)}function C(t,e,n){if(e>A)throw Error(g);return T(new t(l),e,n,!0)}function R(t){var e=t.length-1,n=e*M+1;if(e=t[e]){for(;e%10==0;e/=10)n--;for(e=t[0];e>=10;e/=10)n++}return n}function k(t){for(var e="";t--;)e+="0";return e}function B(t,e,n,r){var s,i=new t(1),a=Math.ceil(r/M+4);for(h=!1;;){if(n%2&&Y((i=i.times(e)).d,a)&&(s=!0),0===(n=m(n/2))){n=i.d.length-1,s&&0===i.d[n]&&++i.d[n];break}Y((e=e.times(e)).d,a)}return h=!0,i}function U(t){return 1&t.d[t.d.length-1]}function W(t,e,n){for(var r,s=new t(e[0]),i=0;++i<e.length;){if(!(r=new t(e[i])).s){s=r;break}s[n](r)&&(s=r)}return s}function F(t,e){var n,r,s,i,a,o,u,p=0,l=0,c=0,d=t.constructor,f=d.rounding,g=d.precision;if(!t.d||!t.d[0]||t.e>17)return new d(t.d?t.d[0]?t.s<0?0:1/0:1:t.s?t.s<0?0:t:NaN);for(null==e?(h=!1,u=g):u=e,o=new d(.03125);t.e>-2;)t=t.times(o),c+=5;for(u+=r=Math.log(b(2,c))/Math.LN10*2+5|0,n=i=a=new d(1),d.precision=u;;){if(i=T(i.times(t),u,1),n=n.times(++l),x((o=a.plus(E(i,n,u,1))).d).slice(0,u)===x(a.d).slice(0,u)){for(s=c;s--;)a=T(a.times(a),u,1);if(null!=e)return d.precision=g,a;if(!(p<3&&H(a.d,u-r,f,p)))return T(a,d.precision=g,f,h=!0);d.precision=u+=10,n=i=o=new d(1),l=0,p++}a=o}}function q(t,e){var n,r,s,i,a,o,u,p,l,c,d,f=1,g=t,y=g.d,O=g.constructor,m=O.rounding,b=O.precision;if(g.s<0||!y||!y[0]||!g.e&&1==y[0]&&1==y.length)return new O(y&&!y[0]?-1/0:1!=g.s?NaN:y?0:g);if(null==e?(h=!1,l=b):l=e,O.precision=l+=10,r=(n=x(y)).charAt(0),!(Math.abs(i=g.e)<15e14))return p=L(O,l+2,b).times(i+""),g=q(new O(r+"."+n.slice(1)),l-10).plus(p),O.precision=b,null==e?T(g,b,m,h=!0):g;for(;r<7&&1!=r||1==r&&n.charAt(1)>3;)r=(n=x((g=g.times(t)).d)).charAt(0),f++;for(i=g.e,r>1?(g=new O("0."+n),i++):g=new O(r+"."+n.slice(1)),c=g,u=a=g=E(g.minus(1),g.plus(1),l,1),d=T(g.times(g),l,1),s=3;;){if(a=T(a.times(d),l,1),x((p=u.plus(E(a,new O(s),l,1))).d).slice(0,l)===x(u.d).slice(0,l)){if(u=u.times(2),0!==i&&(u=u.plus(L(O,l+2,b).times(i+""))),u=E(u,new O(f),l,1),null!=e)return O.precision=b,u;if(!H(u.d,l-10,m,o))return T(u,O.precision=b,m,h=!0);O.precision=l+=10,p=a=g=E(c.minus(1),c.plus(1),l,1),d=T(g.times(g),l,1),s=o=1}u=p,s+=2}}function G(t){return String(t.s*t.s/0)}function J(t,e){var n,r,s;for((n=e.indexOf("."))>-1&&(e=e.replace(".","")),(r=e.search(/e/i))>0?(n<0&&(n=r),n+=+e.slice(r+1),e=e.substring(0,r)):n<0&&(n=e.length),r=0;48===e.charCodeAt(r);r++);for(s=e.length;48===e.charCodeAt(s-1);--s);if(e=e.slice(r,s)){if(s-=r,t.e=n=n-r-1,t.d=[],r=(n+1)%M,n<0&&(r+=M),r<s){for(r&&t.d.push(+e.slice(0,r)),s-=M;r<s;)t.d.push(+e.slice(r,r+=M));e=e.slice(r),r=M-e.length}else r-=s;for(;r--;)e+="0";t.d.push(+e),h&&(t.e>t.constructor.maxE?(t.d=null,t.e=NaN):t.e<t.constructor.minE&&(t.e=0,t.d=[0]))}else t.e=0,t.d=[0];return t}function z(t,e){var r,s,i,a,o,u,p,l,c;if(e.indexOf("_")>-1){if(e=e.replace(/(\d)_(?=\d)/g,"$1"),w.test(e))return J(t,e)}else if("Infinity"===e||"NaN"===e)return+e||(t.s=NaN),t.e=NaN,t.d=null,t;if(N.test(e))r=16,e=e.toLowerCase();else if(S.test(e))r=2;else{if(!I.test(e))throw Error(f+e);r=8}for((a=e.search(/p/i))>0?(p=+e.slice(a+1),e=e.substring(2,a)):e=e.slice(2),o=(a=e.indexOf("."))>=0,s=t.constructor,o&&(a=(u=(e=e.replace(".","")).length)-a,i=B(s,new s(r),a,2*a)),a=c=(l=V(e,r,j)).length-1;0===l[a];--a)l.pop();return a<0?new s(0*t.s):(t.e=_(l,c),t.d=l,h=!1,o&&(t=E(t,i,4*u)),p&&(t=t.times(Math.abs(p)<54?b(2,p):n.pow(2,p))),h=!0,t)}function Z(t,e,n,r,s){var i,a,o,u,p=t.precision,l=Math.ceil(p/M);for(h=!1,u=n.times(n),o=new t(r);;){if(a=E(o.times(u),new t(e++*e++),p,1),o=s?r.plus(a):r.minus(a),r=E(a.times(u),new t(e++*e++),p,1),void 0!==(a=o.plus(r)).d[l]){for(i=l;a.d[i]===o.d[i]&&i--;);if(-1==i)break}i=o,o=r,r=a,a=i}return h=!0,a.d.length=l+1,a}function Q(t,e){for(var n=t;--e;)n*=t;return n}function K(t,e){var n,r=e.s<0,s=C(t,t.precision,1),a=s.times(.5);if((e=e.abs()).lte(a))return i=r?4:1,e;if((n=e.divToInt(s)).isZero())i=r?3:2;else{if((e=e.minus(n.times(s))).lte(a))return i=U(n)?r?2:3:r?4:1,e;i=U(n)?r?1:4:r?3:2}return e.minus(s).abs()}function X(t,e,n,s){var i,a,p,l,c,h,d,f,g,y=t.constructor,O=void 0!==n;if(O?(D(n,1,o),void 0===s?s=y.rounding:D(s,0,8)):(n=y.precision,s=y.rounding),t.isFinite()){for(O?(i=2,16==e?n=4*n-3:8==e&&(n=3*n-2)):i=e,(p=(d=$(t)).indexOf("."))>=0&&(d=d.replace(".",""),(g=new y(1)).e=d.length-p,g.d=V($(g),10,i),g.e=g.d.length),a=c=(f=V(d,10,i)).length;0==f[--c];)f.pop();if(f[0]){if(p<0?a--:((t=new y(t)).d=f,t.e=a,f=(t=E(t,g,n,s,0,i)).d,a=t.e,h=r),p=f[n],l=i/2,h=h||void 0!==f[n+1],h=s<4?(void 0!==p||h)&&(0===s||s===(t.s<0?3:2)):p>l||p===l&&(4===s||h||6===s&&1&f[n-1]||s===(t.s<0?8:7)),f.length=n,h)for(;++f[--n]>i-1;)f[n]=0,n||(++a,f.unshift(1));for(c=f.length;!f[c-1];--c);for(p=0,d="";p<c;p++)d+=u.charAt(f[p]);if(O){if(c>1)if(16==e||8==e){for(p=16==e?4:3,--c;c%p;c++)d+="0";for(c=(f=V(d,i,e)).length;!f[c-1];--c);for(p=1,d="1.";p<c;p++)d+=u.charAt(f[p])}else d=d.charAt(0)+"."+d.slice(1);d=d+(a<0?"p":"p+")+a}else if(a<0){for(;++a;)d="0"+d;d="0."+d}else if(++a>c)for(a-=c;a--;)d+="0";else a<c&&(d=d.slice(0,a)+"."+d.slice(a))}else d=O?"0p+0":"0";d=(16==e?"0x":2==e?"0b":8==e?"0o":"")+d}else d=G(t);return t.s<0?"-"+d:d}function Y(t,e){if(t.length>e)return t.length=e,!0}function tt(t){return new this(t).abs()}function et(t){return new this(t).acos()}function nt(t){return new this(t).acosh()}function rt(t,e){return new this(t).plus(e)}function st(t){return new this(t).asin()}function it(t){return new this(t).asinh()}function at(t){return new this(t).atan()}function ot(t){return new this(t).atanh()}function ut(t,e){t=new this(t),e=new this(e);var n,r=this.precision,s=this.rounding,i=r+4;return t.s&&e.s?t.d||e.d?!e.d||t.isZero()?(n=e.s<0?C(this,r,s):new this(0)).s=t.s:!t.d||e.isZero()?(n=C(this,i,1).times(.5)).s=t.s:e.s<0?(this.precision=i,this.rounding=1,n=this.atan(E(t,e,i,1)),e=C(this,i,1),this.precision=r,this.rounding=s,n=t.s<0?n.minus(e):n.plus(e)):n=this.atan(E(t,e,i,1)):(n=C(this,i,1).times(e.s>0?.25:.75)).s=t.s:n=new this(NaN),n}function pt(t){return new this(t).cbrt()}function lt(t){return T(t=new this(t),t.e+1,2)}function ct(t,e,n){return new this(t).clamp(e,n)}function ht(t){if(!t||"object"!=typeof t)throw Error(d+"Object expected");var e,n,r,s=!0===t.defaults,i=["precision",1,o,"rounding",0,8,"toExpNeg",-a,0,"toExpPos",0,a,"maxE",0,a,"minE",-a,0,"modulo",0,9];for(e=0;e<i.length;e+=3)if(n=i[e],s&&(this[n]=c[n]),void 0!==(r=t[n])){if(!(m(r)===r&&r>=i[e+1]&&r<=i[e+2]))throw Error(f+n+": "+r);this[n]=r}if(n="crypto",s&&(this[n]=c[n]),void 0!==(r=t[n])){if(!0!==r&&!1!==r&&0!==r&&1!==r)throw Error(f+n+": "+r);if(r){if("undefined"==typeof crypto||!crypto||!crypto.getRandomValues&&!crypto.randomBytes)throw Error(y);this[n]=!0}else this[n]=!1}return this}function dt(t){return new this(t).cos()}function ft(t){return new this(t).cosh()}function gt(t,e){return new this(t).div(e)}function yt(t){return new this(t).exp()}function Ot(t){return T(t=new this(t),t.e+1,3)}function mt(){var t,e,n=new this(0);for(h=!1,t=0;t<arguments.length;)if((e=new this(arguments[t++])).d)n.d&&(n=n.plus(e.times(e)));else{if(e.s)return h=!0,new this(1/0);n=e}return h=!0,n.sqrt()}function bt(t){return t instanceof n||t&&t.toStringTag===O||!1}function St(t){return new this(t).ln()}function Nt(t,e){return new this(t).log(e)}function It(t){return new this(t).log(2)}function wt(t){return new this(t).log(10)}function jt(){return W(this,arguments,"lt")}function Mt(){return W(this,arguments,"gt")}function vt(t,e){return new this(t).mod(e)}function At(t,e){return new this(t).mul(e)}function Pt(t,e){return new this(t).pow(e)}function xt(t){var e,n,r,s,i=0,a=new this(1),u=[];if(void 0===t?t=this.precision:D(t,1,o),r=Math.ceil(t/M),this.crypto)if(crypto.getRandomValues)for(e=crypto.getRandomValues(new Uint32Array(r));i<r;)(s=e[i])>=429e7?e[i]=crypto.getRandomValues(new Uint32Array(1))[0]:u[i++]=s%1e7;else{if(!crypto.randomBytes)throw Error(y);for(e=crypto.randomBytes(r*=4);i<r;)(s=e[i]+(e[i+1]<<8)+(e[i+2]<<16)+((127&e[i+3])<<24))>=214e7?crypto.randomBytes(4).copy(e,i):(u.push(s%1e7),i+=4);i=r/4}else for(;i<r;)u[i++]=1e7*Math.random()|0;for(r=u[--i],t%=M,r&&t&&(s=b(10,M-t),u[i]=(r/s|0)*s);0===u[i];i--)u.pop();if(i<0)n=0,u=[0];else{for(n=-1;0===u[0];n-=M)u.shift();for(r=1,s=u[0];s>=10;s/=10)r++;r<M&&(n-=M-r)}return a.e=n,a.d=u,a}function Dt(t){return T(t=new this(t),t.e+1,this.rounding)}function Ht(t){return(t=new this(t)).d?t.d[0]?t.s:0*t.s:t.s||NaN}function Vt(t){return new this(t).sin()}function Et(t){return new this(t).sinh()}function Tt(t){return new this(t).sqrt()}function $t(t,e){return new this(t).sub(e)}function _t(){var t=0,e=arguments,n=new this(e[t]);for(h=!1;n.s&&++t<e.length;)n=n.plus(e[t]);return h=!0,T(n,this.precision,this.rounding)}function Lt(t){return new this(t).tan()}function Ct(t){return new this(t).tanh()}function Rt(t){return T(t=new this(t),t.e+1,1)}n=function t(e){var n,r,s;function i(t){var e,n,r,s=this;if(!(s instanceof i))return new i(t);if(s.constructor=i,bt(t))return s.s=t.s,void(h?!t.d||t.e>i.maxE?(s.e=NaN,s.d=null):t.e<i.minE?(s.e=0,s.d=[0]):(s.e=t.e,s.d=t.d.slice()):(s.e=t.e,s.d=t.d?t.d.slice():t.d));if("number"===(r=typeof t)){if(0===t)return s.s=1/t<0?-1:1,s.e=0,void(s.d=[0]);if(t<0?(t=-t,s.s=-1):s.s=1,t===~~t&&t<1e7){for(e=0,n=t;n>=10;n/=10)e++;return void(h?e>i.maxE?(s.e=NaN,s.d=null):e<i.minE?(s.e=0,s.d=[0]):(s.e=e,s.d=[t]):(s.e=e,s.d=[t]))}return 0*t!=0?(t||(s.s=NaN),s.e=NaN,void(s.d=null)):J(s,t.toString())}if("string"!==r)throw Error(f+t);return 45===(n=t.charCodeAt(0))?(t=t.slice(1),s.s=-1):(43===n&&(t=t.slice(1)),s.s=1),w.test(t)?J(s,t):z(s,t)}if(i.prototype=P,i.ROUND_UP=0,i.ROUND_DOWN=1,i.ROUND_CEIL=2,i.ROUND_FLOOR=3,i.ROUND_HALF_UP=4,i.ROUND_HALF_DOWN=5,i.ROUND_HALF_EVEN=6,i.ROUND_HALF_CEIL=7,i.ROUND_HALF_FLOOR=8,i.EUCLID=9,i.config=i.set=ht,i.clone=t,i.isDecimal=bt,i.abs=tt,i.acos=et,i.acosh=nt,i.add=rt,i.asin=st,i.asinh=it,i.atan=at,i.atanh=ot,i.atan2=ut,i.cbrt=pt,i.ceil=lt,i.clamp=ct,i.cos=dt,i.cosh=ft,i.div=gt,i.exp=yt,i.floor=Ot,i.hypot=mt,i.ln=St,i.log=Nt,i.log10=wt,i.log2=It,i.max=jt,i.min=Mt,i.mod=vt,i.mul=At,i.pow=Pt,i.random=xt,i.round=Dt,i.sign=Ht,i.sin=Vt,i.sinh=Et,i.sqrt=Tt,i.sub=$t,i.sum=_t,i.tan=Lt,i.tanh=Ct,i.trunc=Rt,void 0===e&&(e={}),e&&!0!==e.defaults)for(s=["precision","rounding","toExpNeg","toExpPos","maxE","minE","modulo","crypto"],n=0;n<s.length;)e.hasOwnProperty(r=s[n++])||(e[r]=this[r]);return i.config(e),i}(c),n.prototype.constructor=n,n.default=n.Decimal=n,p=new n(p),l=new n(l),void 0!==e&&e.exports?("function"==typeof Symbol&&"symbol"==typeof Symbol.iterator&&(P[Symbol.for("nodejs.util.inspect.custom")]=P.toString,P[Symbol.toStringTag]="Decimal"),e.exports=n):(t||(t="undefined"!=typeof self&&self&&self.self==self?self:window),s=t.Decimal,n.noConflict=function(){return t.Decimal=s,n},t.Decimal=n)}(this)},{}],2:[function(t,e,n){e.exports=
/**
      * @license MIT
...
/**
      ...
      * @author <steven@velozo.com>
      */
var r=t("./Manyfest.js");"object"==typeof window&&(window.Manyfest=r),e.exports=r},{"./Manyfest.js":57}],48:[function(t,e,n){arguments[4][34][0].apply(n,arguments)},{dup:34}],49:[function(t,e,n){arguments[4][35][0].apply(n,arguments)},{"./Manyfest-LogToConsole.js":50,dup:35}],50:[function(t,e,n){arguments[4][36][0].apply(n,arguments)},{dup:36}],51:[function(t,e,n){arguments[4][37][0].apply(n,arguments)},{"./Manyfest-LogToConsole.js":50,dup:37}],52:[function(t,e,n){arguments[4][38][0].apply(n,arguments)},{"./Manyfest-CleanWrapCharacters.js":48,"./Manyfest-LogToConsole.js":50,dup:38,elucidator:4,precedent:44}],53:[function(t,e,n){arguments[4][39][0].apply(n,arguments)},{"./Manyfest-CleanWrapCharacters.js":48,"./Manyfest-LogToConsole.js":50,dup:39,elucidator:4,precedent:44}],54:[function(t,e,n){arguments[4][40][0].apply(n,arguments)},{"./Manyfest-CleanWrapCharacters.js":48,"./Manyfest-LogToConsole.js":50,dup:40,precedent:44}],55:[function(t,e,n){arguments[4][41][0].apply(n,arguments)},{"./Manyfest-LogToConsole.js":50,dup:41}],56:[function(t,e,n){arguments[4][42][0].apply(n,arguments)},{"./Manyfest-LogToConsole.js":50,dup:42}],57:[function(t,e,n){arguments[4][43][0].apply(n,arguments)},{"./Manyfest-HashTranslation.js":49,"./Manyfest-LogToConsole.js":50,"./Manyfest-ObjectAddress-CheckAddressExists.js":51,"./Manyfest-ObjectAddress-DeleteValue.js":52,"./Manyfest-ObjectAddress-GetValue.js":53,"./Manyfest-ObjectAddress-SetValue.js":54,"./Manyfest-ObjectAddressGeneration.js":55,"./Manyfest-SchemaManipulation.js":56,dup:43,elucidator:4,precedent:44}]},{},[47])(47)}));
