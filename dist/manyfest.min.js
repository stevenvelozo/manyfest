...
/*!
   ...
   *  MIT Licence
   */var r,s,n,i,a=9e15,o=1e9,u="0123456789abcdef",p="2.",l="3.",c={precision:20,rounding:4,modulo:1,toExpNeg:-7,toExpPos:21,minE:-a,maxE:a,crypto:!1},h=!0,d="[DecimalError] ",f=d+"Invalid argument: ",g=d+"Precision limit exceeded",y=d+"crypto unavailable",m="[object Decimal]",O=Math.floor,b=Math.pow,w=/^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i,N=/^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i,S=/^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i,I=/^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i,A=1e7,j=p.length-1,v=l.length-1,x={toStringTag:m};function M(t){var e,r,s,n=t.length-1,i="",a=t[0];if(n>0){for(i+=a,e=1;e<n;e++)(r=7-(s=t[e]+"").length)&&(i+=R(r)),i+=s;(r=7-(s=(a=t[e])+"").length)&&(i+=R(r))}else if(0===a)return"0";for(;a%10==0;)a/=10;return i+a}function D(t,e,r){if(t!==~~t||t<e||t>r)throw Error(f+t)}function E(t,e,r,s){var n,i,a,o;for(i=t[0];i>=10;i/=10)--e;return--e<0?(e+=7,n=0):(n=Math.ceil((e+1)/7),e%=7),i=b(10,7-e),o=t[n]%i|0,null==s?e<3?(0==e?o=o/100|0:1==e&&(o=o/10|0),a=r<4&&99999==o||r>3&&49999==o||5e4==o||0==o):a=(r<4&&o+1==i||r>3&&o+1==i/2)&&(t[n+1]/i/100|0)==b(10,e-2)-1||(o==i/2||0==o)&&0==(t[n+1]/i/100|0):e<4?(0==e?o=o/1e3|0:1==e?o=o/100|0:2==e&&(o=o/10|0),a=(s||r<4)&&9999==o||!s&&r>3&&4999==o):a=((s||r<4)&&o+1==i||!s&&r>3&&o+1==i/2)&&(t[n+1]/i/1e3|0)==b(10,e-3)-1,a}function P(t,e,r){for(var s,n,i=[0],a=0,o=t.length;a<o;){for(n=i.length;n--;)i[n]*=e;for(i[0]+=u.indexOf(t.charAt(a++)),s=0;s<i.length;s++)i[s]>r-1&&(void 0===i[s+1]&&(i[s+1]=0),i[s+1]+=i[s]/r|0,i[s]%=r)}return i.reverse()}x.absoluteValue=x.abs=function(){var t=new this.constructor(this);return t.s<0&&(t.s=1),T(t)},x.ceil=function(){return T(new this.constructor(this),this.e+1,2)},x.clampedTo=x.clamp=function(t,e){var r=this,s=r.constructor;if(t=new s(t),e=new s(e),!t.s||!e.s)return new s(NaN);if(t.gt(e))throw Error(f+e);return r.cmp(t)<0?t:r.cmp(e)>0?e:new s(r)},x.comparedTo=x.cmp=function(t){var e,r,s,n,i=this,a=i.d,o=(t=new i.constructor(t)).d,u=i.s,p=t.s;if(!a||!o)return u&&p?u!==p?u:a===o?0:!a^u<0?1:-1:NaN;if(!a[0]||!o[0])return a[0]?u:o[0]?-p:0;if(u!==p)return u;if(i.e!==t.e)return i.e>t.e^u<0?1:-1;for(e=0,r=(s=a.length)<(n=o.length)?s:n;e<r;++e)if(a[e]!==o[e])return a[e]>o[e]^u<0?1:-1;return s===n?0:s>n^u<0?1:-1},x.cosine=x.cos=function(){var t,e,r=this,s=r.constructor;return r.d?r.d[0]?(t=s.precision,e=s.rounding,s.precision=t+Math.max(r.e,r.sd())+7,s.rounding=1,r=function(t,e){var r,s,n;if(e.isZero())return e;(s=e.d.length)<32?n=(1/G(4,r=Math.ceil(s/3))).toString():(r=16,n="2.3283064365386962890625e-10");t.precision+=r,e=Z(t,1,e.times(n),new t(1));for(var i=r;i--;){var a=e.times(e);e=a.times(a).minus(a).times(8).plus(1)}return t.precision-=r,e}(s,Q(s,r)),s.precision=t,s.rounding=e,T(2==i||3==i?r.neg():r,t,e,!0)):new s(1):new s(NaN)},x.cubeRoot=x.cbrt=function(){var t,e,r,s,n,i,a,o,u,p,l=this,c=l.constructor;if(!l.isFinite()||l.isZero())return new c(l);for(h=!1,(i=l.s*b(l.s*l,1/3))&&Math.abs(i)!=1/0?s=new c(i.toString()):(r=M(l.d),(i=((t=l.e)-r.length+1)%3)&&(r+=1==i||-2==i?"0":"00"),i=b(r,1/3),t=O((t+1)/3)-(t%3==(t<0?-1:2)),(s=new c(r=i==1/0?"5e"+t:(r=i.toExponential()).slice(0,r.indexOf("e")+1)+t)).s=l.s),a=(t=c.precision)+3;;)if(p=(u=(o=s).times(o).times(o)).plus(l),s=H(p.plus(l).times(o),p.plus(u),a+2,1),M(o.d).slice(0,a)===(r=M(s.d)).slice(0,a)){if("9999"!=(r=r.slice(a-3,a+1))&&(n||"4999"!=r)){+r&&(+r.slice(1)||"5"!=r.charAt(0))||(T(s,t+1,1),e=!s.times(s).times(s).eq(l));break}if(!n&&(T(o,t+1,0),o.times(o).times(o).eq(l))){s=o;break}a+=4,n=1}return h=!0,T(s,t,c.rounding,e)},x.decimalPlaces=x.dp=function(){var t,e=this.d,r=NaN;if(e){if(r=7*((t=e.length-1)-O(this.e/7)),t=e[t])for(;t%10==0;t/=10)r--;r<0&&(r=0)}return r},x.dividedBy=x.div=function(t){return H(this,new this.constructor(t))},x.dividedToIntegerBy=x.divToInt=function(t){var e=this.constructor;return T(H(this,new e(t),0,1,1),e.precision,e.rounding)},x.equals=x.eq=function(t){return 0===this.cmp(t)},x.floor=function(){return T(new this.constructor(this),this.e+1,3)},x.greaterThan=x.gt=function(t){return this.cmp(t)>0},x.greaterThanOrEqualTo=x.gte=function(t){var e=this.cmp(t);return 1==e||0===e},x.hyperbolicCosine=x.cosh=function(){var t,e,r,s,n,i=this,a=i.constructor,o=new a(1);if(!i.isFinite())return new a(i.s?1/0:NaN);if(i.isZero())return o;r=a.precision,s=a.rounding,a.precision=r+Math.max(i.e,i.sd())+4,a.rounding=1,(n=i.d.length)<32?e=(1/G(4,t=Math.ceil(n/3))).toString():(t=16,e="2.3283064365386962890625e-10"),i=Z(a,1,i.times(e),new a(1),!0);for(var u,p=t,l=new a(8);p--;)u=i.times(i),i=o.minus(u.times(l.minus(u.times(l))));return T(i,a.precision=r,a.rounding=s,!0)},x.hyperbolicSine=x.sinh=function(){var t,e,r,s,n=this,i=n.constructor;if(!n.isFinite()||n.isZero())return new i(n);if(e=i.precision,r=i.rounding,i.precision=e+Math.max(n.e,n.sd())+4,i.rounding=1,(s=n.d.length)<3)n=Z(i,2,n,n,!0);else{t=(t=1.4*Math.sqrt(s))>16?16:0|t,n=Z(i,2,n=n.times(1/G(5,t)),n,!0);for(var a,o=new i(5),u=new i(16),p=new i(20);t--;)a=n.times(n),n=n.times(o.plus(a.times(u.times(a).plus(p))))}return i.precision=e,i.rounding=r,T(n,e,r,!0)},x.hyperbolicTangent=x.tanh=function(){var t,e,r=this,s=r.constructor;return r.isFinite()?r.isZero()?new s(r):(t=s.precision,e=s.rounding,s.precision=t+7,s.rounding=1,H(r.sinh(),r.cosh(),s.precision=t,s.rounding=e)):new s(r.s)},x.inverseCosine=x.acos=function(){var t,e=this,r=e.constructor,s=e.abs().cmp(1),n=r.precision,i=r.rounding;return-1!==s?0===s?e.isNeg()?L(r,n,i):new r(0):new r(NaN):e.isZero()?L(r,n+4,i).times(.5):(r.precision=n+6,r.rounding=1,e=e.asin(),t=L(r,n+4,i).times(.5),r.precision=n,r.rounding=i,t.minus(e))},x.inverseHyperbolicCosine=x.acosh=function(){var t,e,r=this,s=r.constructor;return r.lte(1)?new s(r.eq(1)?0:NaN):r.isFinite()?(t=s.precision,e=s.rounding,s.precision=t+Math.max(Math.abs(r.e),r.sd())+4,s.rounding=1,h=!1,r=r.times(r).minus(1).sqrt().plus(r),h=!0,s.precision=t,s.rounding=e,r.ln()):new s(r)},x.inverseHyperbolicSine=x.asinh=function(){var t,e,r=this,s=r.constructor;return!r.isFinite()||r.isZero()?new s(r):(t=s.precision,e=s.rounding,s.precision=t+2*Math.max(Math.abs(r.e),r.sd())+6,s.rounding=1,h=!1,r=r.times(r).plus(1).sqrt().plus(r),h=!0,s.precision=t,s.rounding=e,r.ln())},x.inverseHyperbolicTangent=x.atanh=function(){var t,e,r,s,n=this,i=n.constructor;return n.isFinite()?n.e>=0?new i(n.abs().eq(1)?n.s/0:n.isZero()?n:NaN):(t=i.precision,e=i.rounding,s=n.sd(),Math.max(s,t)<2*-n.e-1?T(new i(n),t,e,!0):(i.precision=r=s-n.e,n=H(n.plus(1),new i(1).minus(n),r+t,1),i.precision=t+4,i.rounding=1,n=n.ln(),i.precision=t,i.rounding=e,n.times(.5))):new i(NaN)},x.inverseSine=x.asin=function(){var t,e,r,s,n=this,i=n.constructor;return n.isZero()?new i(n):(e=n.abs().cmp(1),r=i.precision,s=i.rounding,-1!==e?0===e?((t=L(i,r+4,s).times(.5)).s=n.s,t):new i(NaN):(i.precision=r+6,i.rounding=1,n=n.div(new i(1).minus(n.times(n)).sqrt().plus(1)).atan(),i.precision=r,i.rounding=s,n.times(2)))},x.inverseTangent=x.atan=function(){var t,e,r,s,n,i,a,o,u,p=this,l=p.constructor,c=l.precision,d=l.rounding;if(p.isFinite()){if(p.isZero())return new l(p);if(p.abs().eq(1)&&c+4<=v)return(a=L(l,c+4,d).times(.25)).s=p.s,a}else{if(!p.s)return new l(NaN);if(c+4<=v)return(a=L(l,c+4,d).times(.5)).s=p.s,a}for(l.precision=o=c+10,l.rounding=1,t=r=Math.min(28,o/7+2|0);t;--t)p=p.div(p.times(p).plus(1).sqrt().plus(1));for(h=!1,e=Math.ceil(o/7),s=1,u=p.times(p),a=new l(p),n=p;-1!==t;)if(n=n.times(u),i=a.minus(n.div(s+=2)),n=n.times(u),void 0!==(a=i.plus(n.div(s+=2))).d[e])for(t=e;a.d[t]===i.d[t]&&t--;);return r&&(a=a.times(2<<r-1)),h=!0,T(a,l.precision=c,l.rounding=d,!0)},x.isFinite=function(){return!!this.d},x.isInteger=x.isInt=function(){return!!this.d&&O(this.e/7)>this.d.length-2},x.isNaN=function(){return!this.s},x.isNegative=x.isNeg=function(){return this.s<0},x.isPositive=x.isPos=function(){return this.s>0},x.isZero=function(){return!!this.d&&0===this.d[0]},x.lessThan=x.lt=function(t){return this.cmp(t)<0},x.lessThanOrEqualTo=x.lte=function(t){return this.cmp(t)<1},x.logarithm=x.log=function(t){var e,r,s,n,i,a,o,u,p=this,l=p.constructor,c=l.precision,d=l.rounding;if(null==t)t=new l(10),e=!0;else{if(r=(t=new l(t)).d,t.s<0||!r||!r[0]||t.eq(1))return new l(NaN);e=t.eq(10)}if(r=p.d,p.s<0||!r||!r[0]||p.eq(1))return new l(r&&!r[0]?-1/0:1!=p.s?NaN:r?0:1/0);if(e)if(r.length>1)i=!0;else{for(n=r[0];n%10==0;)n/=10;i=1!==n}if(h=!1,a=J(p,o=c+5),s=e?C(l,o+10):J(t,o),E((u=H(a,s,o,1)).d,n=c,d))do{if(a=J(p,o+=10),s=e?C(l,o+10):J(t,o),u=H(a,s,o,1),!i){+M(u.d).slice(n+1,n+15)+1==1e14&&(u=T(u,c+1,0));break}}while(E(u.d,n+=10,d));return h=!0,T(u,c,d)},x.minus=x.sub=function(t){var e,r,s,n,i,a,o,u,p,l,c,d,f=this,g=f.constructor;if(t=new g(t),!f.d||!t.d)return f.s&&t.s?f.d?t.s=-t.s:t=new g(t.d||f.s!==t.s?f:NaN):t=new g(NaN),t;if(f.s!=t.s)return t.s=-t.s,f.plus(t);if(p=f.d,d=t.d,o=g.precision,u=g.rounding,!p[0]||!d[0]){if(d[0])t.s=-t.s;else{if(!p[0])return new g(3===u?-0:0);t=new g(f)}return h?T(t,o,u):t}if(r=O(t.e/7),l=O(f.e/7),p=p.slice(),i=l-r){for((c=i<0)?(e=p,i=-i,a=d.length):(e=d,r=l,a=p.length),i>(s=Math.max(Math.ceil(o/7),a)+2)&&(i=s,e.length=1),e.reverse(),s=i;s--;)e.push(0);e.reverse()}else{for((c=(s=p.length)<(a=d.length))&&(a=s),s=0;s<a;s++)if(p[s]!=d[s]){c=p[s]<d[s];break}i=0}for(c&&(e=p,p=d,d=e,t.s=-t.s),a=p.length,s=d.length-a;s>0;--s)p[a++]=0;for(s=d.length;s>i;){if(p[--s]<d[s]){for(n=s;n&&0===p[--n];)p[n]=A-1;--p[n],p[s]+=A}p[s]-=d[s]}for(;0===p[--a];)p.pop();for(;0===p[0];p.shift())--r;return p[0]?(t.d=p,t.e=$(p,r),h?T(t,o,u):t):new g(3===u?-0:0)},x.modulo=x.mod=function(t){var e,r=this,s=r.constructor;return t=new s(t),!r.d||!t.s||t.d&&!t.d[0]?new s(NaN):!t.d||r.d&&!r.d[0]?T(new s(r),s.precision,s.rounding):(h=!1,9==s.modulo?(e=H(r,t.abs(),0,3,1)).s*=t.s:e=H(r,t,0,s.modulo,1),e=e.times(t),h=!0,r.minus(e))},x.naturalExponential=x.exp=function(){return F(this)},x.naturalLogarithm=x.ln=function(){return J(this)},x.negated=x.neg=function(){var t=new this.constructor(this);return t.s=-t.s,T(t)},x.plus=x.add=function(t){var e,r,s,n,i,a,o,u,p,l,c=this,d=c.constructor;if(t=new d(t),!c.d||!t.d)return c.s&&t.s?c.d||(t=new d(t.d||c.s===t.s?c:NaN)):t=new d(NaN),t;if(c.s!=t.s)return t.s=-t.s,c.minus(t);if(p=c.d,l=t.d,o=d.precision,u=d.rounding,!p[0]||!l[0])return l[0]||(t=new d(c)),h?T(t,o,u):t;if(i=O(c.e/7),s=O(t.e/7),p=p.slice(),n=i-s){for(n<0?(r=p,n=-n,a=l.length):(r=l,s=i,a=p.length),n>(a=(i=Math.ceil(o/7))>a?i+1:a+1)&&(n=a,r.length=1),r.reverse();n--;)r.push(0);r.reverse()}for((a=p.length)-(n=l.length)<0&&(n=a,r=l,l=p,p=r),e=0;n;)e=(p[--n]=p[n]+l[n]+e)/A|0,p[n]%=A;for(e&&(p.unshift(e),++s),a=p.length;0==p[--a];)p.pop();return t.d=p,t.e=$(p,s),h?T(t,o,u):t},x.precision=x.sd=function(t){var e,r=this;if(void 0!==t&&t!==!!t&&1!==t&&0!==t)throw Error(f+t);return r.d?(e=B(r.d),t&&r.e+1>e&&(e=r.e+1)):e=NaN,e},x.round=function(){var t=this,e=t.constructor;return T(new e(t),t.e+1,e.rounding)},x.sine=x.sin=function(){var t,e,r=this,s=r.constructor;return r.isFinite()?r.isZero()?new s(r):(t=s.precision,e=s.rounding,s.precision=t+Math.max(r.e,r.sd())+7,s.rounding=1,r=function(t,e){var r,s=e.d.length;if(s<3)return e.isZero()?e:Z(t,2,e,e);r=(r=1.4*Math.sqrt(s))>16?16:0|r,e=e.times(1/G(5,r)),e=Z(t,2,e,e);for(var n,i=new t(5),a=new t(16),o=new t(20);r--;)n=e.times(e),e=e.times(i.plus(n.times(a.times(n).minus(o))));return e}(s,Q(s,r)),s.precision=t,s.rounding=e,T(i>2?r.neg():r,t,e,!0)):new s(NaN)},x.squareRoot=x.sqrt=function(){var t,e,r,s,n,i,a=this,o=a.d,u=a.e,p=a.s,l=a.constructor;if(1!==p||!o||!o[0])return new l(!p||p<0&&(!o||o[0])?NaN:o?a:1/0);for(h=!1,0==(p=Math.sqrt(+a))||p==1/0?(((e=M(o)).length+u)%2==0&&(e+="0"),p=Math.sqrt(e),u=O((u+1)/2)-(u<0||u%2),s=new l(e=p==1/0?"5e"+u:(e=p.toExponential()).slice(0,e.indexOf("e")+1)+u)):s=new l(p.toString()),r=(u=l.precision)+3;;)if(s=(i=s).plus(H(a,i,r+2,1)).times(.5),M(i.d).slice(0,r)===(e=M(s.d)).slice(0,r)){if("9999"!=(e=e.slice(r-3,r+1))&&(n||"4999"!=e)){+e&&(+e.slice(1)||"5"!=e.charAt(0))||(T(s,u+1,1),t=!s.times(s).eq(a));break}if(!n&&(T(i,u+1,0),i.times(i).eq(a))){s=i;break}r+=4,n=1}return h=!0,T(s,u,l.rounding,t)},x.tangent=x.tan=function(){var t,e,r=this,s=r.constructor;return r.isFinite()?r.isZero()?new s(r):(t=s.precision,e=s.rounding,s.precision=t+10,s.rounding=1,(r=r.sin()).s=1,r=H(r,new s(1).minus(r.times(r)).sqrt(),t+10,0),s.precision=t,s.rounding=e,T(2==i||4==i?r.neg():r,t,e,!0)):new s(NaN)},x.times=x.mul=function(t){var e,r,s,n,i,a,o,u,p,l=this,c=l.constructor,d=l.d,f=(t=new c(t)).d;if(t.s*=l.s,!(d&&d[0]&&f&&f[0]))return new c(!t.s||d&&!d[0]&&!f||f&&!f[0]&&!d?NaN:d&&f?0*t.s:t.s/0);for(r=O(l.e/7)+O(t.e/7),(u=d.length)<(p=f.length)&&(i=d,d=f,f=i,a=u,u=p,p=a),i=[],s=a=u+p;s--;)i.push(0);for(s=p;--s>=0;){for(e=0,n=u+s;n>s;)o=i[n]+f[s]*d[n-s-1]+e,i[n--]=o%A|0,e=o/A|0;i[n]=(i[n]+e)%A|0}for(;!i[--a];)i.pop();return e?++r:i.shift(),t.d=i,t.e=$(i,r),h?T(t,c.precision,c.rounding):t},x.toBinary=function(t,e){return K(this,2,t,e)},x.toDecimalPlaces=x.toDP=function(t,e){var r=this,s=r.constructor;return r=new s(r),void 0===t?r:(D(t,0,o),void 0===e?e=s.rounding:D(e,0,8),T(r,t+r.e+1,e))},x.toExponential=function(t,e){var r,s=this,n=s.constructor;return void 0===t?r=V(s,!0):(D(t,0,o),void 0===e?e=n.rounding:D(e,0,8),r=V(s=T(new n(s),t+1,e),!0,t+1)),s.isNeg()&&!s.isZero()?"-"+r:r},x.toFixed=function(t,e){var r,s,n=this,i=n.constructor;return void 0===t?r=V(n):(D(t,0,o),void 0===e?e=i.rounding:D(e,0,8),r=V(s=T(new i(n),t+n.e+1,e),!1,t+s.e+1)),n.isNeg()&&!n.isZero()?"-"+r:r},x.toFraction=function(t){var e,r,s,n,i,a,o,u,p,l,c,d,g=this,y=g.d,m=g.constructor;if(!y)return new m(g);if(p=r=new m(1),s=u=new m(0),a=(i=(e=new m(s)).e=B(y)-g.e-1)%7,e.d[0]=b(10,a<0?7+a:a),null==t)t=i>0?e:p;else{if(!(o=new m(t)).isInt()||o.lt(p))throw Error(f+o);t=o.gt(e)?i>0?e:p:o}for(h=!1,o=new m(M(y)),l=m.precision,m.precision=i=7*y.length*2;c=H(o,e,0,1,1),1!=(n=r.plus(c.times(s))).cmp(t);)r=s,s=n,n=p,p=u.plus(c.times(n)),u=n,n=e,e=o.minus(c.times(n)),o=n;return n=H(t.minus(r),s,0,1,1),u=u.plus(n.times(p)),r=r.plus(n.times(s)),u.s=p.s=g.s,d=H(p,s,i,1).minus(g).abs().cmp(H(u,r,i,1).minus(g).abs())<1?[p,s]:[u,r],m.precision=l,h=!0,d},x.toHexadecimal=x.toHex=function(t,e){return K(this,16,t,e)},x.toNearest=function(t,e){var r=this,s=r.constructor;if(r=new s(r),null==t){if(!r.d)return r;t=new s(1),e=s.rounding}else{if(t=new s(t),void 0===e?e=s.rounding:D(e,0,8),!r.d)return t.s?r:t;if(!t.d)return t.s&&(t.s=r.s),t}return t.d[0]?(h=!1,r=H(r,t,0,e,1).times(t),h=!0,T(r)):(t.s=r.s,r=t),r},x.toNumber=function(){return+this},x.toOctal=function(t,e){return K(this,8,t,e)},x.toPower=x.pow=function(t){var e,r,s,n,i,a,o=this,u=o.constructor,p=+(t=new u(t));if(!(o.d&&t.d&&o.d[0]&&t.d[0]))return new u(b(+o,p));if((o=new u(o)).eq(1))return o;if(s=u.precision,i=u.rounding,t.eq(1))return T(o,s,i);if((e=O(t.e/7))>=t.d.length-1&&(r=p<0?-p:p)<=9007199254740991)return n=k(u,o,r,s),t.s<0?new u(1).div(n):T(n,s,i);if((a=o.s)<0){if(e<t.d.length-1)return new u(NaN);if(0==(1&t.d[e])&&(a=1),0==o.e&&1==o.d[0]&&1==o.d.length)return o.s=a,o}return(e=0!=(r=b(+o,p))&&isFinite(r)?new u(r+"").e:O(p*(Math.log("0."+M(o.d))/Math.LN10+o.e+1)))>u.maxE+1||e<u.minE-1?new u(e>0?a/0:0):(h=!1,u.rounding=o.s=1,r=Math.min(12,(e+"").length),(n=F(t.times(J(o,s+r)),s)).d&&E((n=T(n,s+5,1)).d,s,i)&&(e=s+10,+M((n=T(F(t.times(J(o,e+r)),e),e+5,1)).d).slice(s+1,s+15)+1==1e14&&(n=T(n,s+1,0))),n.s=a,h=!0,u.rounding=i,T(n,s,i))},x.toPrecision=function(t,e){var r,s=this,n=s.constructor;return void 0===t?r=V(s,s.e<=n.toExpNeg||s.e>=n.toExpPos):(D(t,1,o),void 0===e?e=n.rounding:D(e,0,8),r=V(s=T(new n(s),t,e),t<=s.e||s.e<=n.toExpNeg,t)),s.isNeg()&&!s.isZero()?"-"+r:r},x.toSignificantDigits=x.toSD=function(t,e){var r=this.constructor;return void 0===t?(t=r.precision,e=r.rounding):(D(t,1,o),void 0===e?e=r.rounding:D(e,0,8)),T(new r(this),t,e)},x.toString=function(){var t=this,e=t.constructor,r=V(t,t.e<=e.toExpNeg||t.e>=e.toExpPos);return t.isNeg()&&!t.isZero()?"-"+r:r},x.truncated=x.trunc=function(){return T(new this.constructor(this),this.e+1,1)},x.valueOf=x.toJSON=function(){var t=this,e=t.constructor,r=V(t,t.e<=e.toExpNeg||t.e>=e.toExpPos);return t.isNeg()?"-"+r:r};var H=function(){function t(t,e,r){var s,n=0,i=t.length;for(t=t.slice();i--;)s=t[i]*e+n,t[i]=s%r|0,n=s/r|0;return n&&t.unshift(n),t}function e(t,e,r,s){var n,i;if(r!=s)i=r>s?1:-1;else for(n=i=0;n<r;n++)if(t[n]!=e[n]){i=t[n]>e[n]?1:-1;break}return i}function r(t,e,r,s){for(var n=0;r--;)t[r]-=n,n=t[r]<e[r]?1:0,t[r]=n*s+t[r]-e[r];for(;!t[0]&&t.length>1;)t.shift()}return function(n,i,a,o,u,p){var l,c,h,d,f,g,y,m,b,w,N,S,I,j,v,x,M,D,E,P,H=n.constructor,V=n.s==i.s?1:-1,$=n.d,C=i.d;if(!($&&$[0]&&C&&C[0]))return new H(n.s&&i.s&&($?!C||$[0]!=C[0]:C)?$&&0==$[0]||!C?0*V:V/0:NaN);for(p?(f=1,c=n.e-i.e):(p=A,f=7,c=O(n.e/f)-O(i.e/f)),E=C.length,M=$.length,w=(b=new H(V)).d=[],h=0;C[h]==($[h]||0);h++);if(C[h]>($[h]||0)&&c--,null==a?(j=a=H.precision,o=H.rounding):j=u?a+(n.e-i.e)+1:a,j<0)w.push(1),g=!0;else{if(j=j/f+2|0,h=0,1==E){for(d=0,C=C[0],j++;(h<M||d)&&j--;h++)v=d*p+($[h]||0),w[h]=v/C|0,d=v%C|0;g=d||h<M}else{for((d=p/(C[0]+1)|0)>1&&(C=t(C,d,p),$=t($,d,p),E=C.length,M=$.length),x=E,S=(N=$.slice(0,E)).length;S<E;)N[S++]=0;(P=C.slice()).unshift(0),D=C[0],C[1]>=p/2&&++D;do{d=0,(l=e(C,N,E,S))<0?(I=N[0],E!=S&&(I=I*p+(N[1]||0)),(d=I/D|0)>1?(d>=p&&(d=p-1),1==(l=e(y=t(C,d,p),N,m=y.length,S=N.length))&&(d--,r(y,E<m?P:C,m,p))):(0==d&&(l=d=1),y=C.slice()),(m=y.length)<S&&y.unshift(0),r(N,y,S,p),-1==l&&(l=e(C,N,E,S=N.length))<1&&(d++,r(N,E<S?P:C,S,p)),S=N.length):0===l&&(d++,N=[0]),w[h++]=d,l&&N[0]?N[S++]=$[x]||0:(N=[$[x]],S=1)}while((x++<M||void 0!==N[0])&&j--);g=void 0!==N[0]}w[0]||w.shift()}if(1==f)b.e=c,s=g;else{for(h=1,d=w[0];d>=10;d/=10)h++;b.e=h+c*f-1,T(b,u?a+b.e+1:a,o,g)}return b}}();function T(t,e,r,s){var n,i,a,o,u,p,l,c,d,f=t.constructor;t:if(null!=e){if(!(c=t.d))return t;for(n=1,o=c[0];o>=10;o/=10)n++;if((i=e-n)<0)i+=7,a=e,u=(l=c[d=0])/b(10,n-a-1)%10|0;else if((d=Math.ceil((i+1)/7))>=(o=c.length)){if(!s)break t;for(;o++<=d;)c.push(0);l=u=0,n=1,a=(i%=7)-7+1}else{for(l=o=c[d],n=1;o>=10;o/=10)n++;u=(a=(i%=7)-7+n)<0?0:l/b(10,n-a-1)%10|0}if(s=s||e<0||void 0!==c[d+1]||(a<0?l:l%b(10,n-a-1)),p=r<4?(u||s)&&(0==r||r==(t.s<0?3:2)):u>5||5==u&&(4==r||s||6==r&&(i>0?a>0?l/b(10,n-a):0:c[d-1])%10&1||r==(t.s<0?8:7)),e<1||!c[0])return c.length=0,p?(e-=t.e+1,c[0]=b(10,(7-e%7)%7),t.e=-e||0):c[0]=t.e=0,t;if(0==i?(c.length=d,o=1,d--):(c.length=d+1,o=b(10,7-i),c[d]=a>0?(l/b(10,n-a)%b(10,a)|0)*o:0),p)for(;;){if(0==d){for(i=1,a=c[0];a>=10;a/=10)i++;for(a=c[0]+=o,o=1;a>=10;a/=10)o++;i!=o&&(t.e++,c[0]==A&&(c[0]=1));break}if(c[d]+=o,c[d]!=A)break;c[d--]=0,o=1}for(i=c.length;0===c[--i];)c.pop()}return h&&(t.e>f.maxE?(t.d=null,t.e=NaN):t.e<f.minE&&(t.e=0,t.d=[0])),t}function V(t,e,r){if(!t.isFinite())return U(t);var s,n=t.e,i=M(t.d),a=i.length;return e?(r&&(s=r-a)>0?i=i.charAt(0)+"."+i.slice(1)+R(s):a>1&&(i=i.charAt(0)+"."+i.slice(1)),i=i+(t.e<0?"e":"e+")+t.e):n<0?(i="0."+R(-n-1)+i,r&&(s=r-a)>0&&(i+=R(s))):n>=a?(i+=R(n+1-a),r&&(s=r-n-1)>0&&(i=i+"."+R(s))):((s=n+1)<a&&(i=i.slice(0,s)+"."+i.slice(s)),r&&(s=r-a)>0&&(n+1===a&&(i+="."),i+=R(s))),i}function $(t,e){var r=t[0];for(e*=7;r>=10;r/=10)e++;return e}function C(t,e,r){if(e>j)throw h=!0,r&&(t.precision=r),Error(g);return T(new t(p),e,1,!0)}function L(t,e,r){if(e>v)throw Error(g);return T(new t(l),e,r,!0)}function B(t){var e=t.length-1,r=7*e+1;if(e=t[e]){for(;e%10==0;e/=10)r--;for(e=t[0];e>=10;e/=10)r++}return r}function R(t){for(var e="";t--;)e+="0";return e}function k(t,e,r,s){var n,i=new t(1),a=Math.ceil(s/7+4);for(h=!1;;){if(r%2&&X((i=i.times(e)).d,a)&&(n=!0),0===(r=O(r/2))){r=i.d.length-1,n&&0===i.d[r]&&++i.d[r];break}X((e=e.times(e)).d,a)}return h=!0,i}function W(t){return 1&t.d[t.d.length-1]}function q(t,e,r){for(var s,n=new t(e[0]),i=0;++i<e.length;){if(!(s=new t(e[i])).s){n=s;break}n[r](s)&&(n=s)}return n}function F(t,e){var r,s,n,i,a,o,u,p=0,l=0,c=0,d=t.constructor,f=d.rounding,g=d.precision;if(!t.d||!t.d[0]||t.e>17)return new d(t.d?t.d[0]?t.s<0?0:1/0:1:t.s?t.s<0?0:t:NaN);for(null==e?(h=!1,u=g):u=e,o=new d(.03125);t.e>-2;)t=t.times(o),c+=5;for(u+=s=Math.log(b(2,c))/Math.LN10*2+5|0,r=i=a=new d(1),d.precision=u;;){if(i=T(i.times(t),u,1),r=r.times(++l),M((o=a.plus(H(i,r,u,1))).d).slice(0,u)===M(a.d).slice(0,u)){for(n=c;n--;)a=T(a.times(a),u,1);if(null!=e)return d.precision=g,a;if(!(p<3&&E(a.d,u-s,f,p)))return T(a,d.precision=g,f,h=!0);d.precision=u+=10,r=i=o=new d(1),l=0,p++}a=o}}function J(t,e){var r,s,n,i,a,o,u,p,l,c,d,f=1,g=t,y=g.d,m=g.constructor,O=m.rounding,b=m.precision;if(g.s<0||!y||!y[0]||!g.e&&1==y[0]&&1==y.length)return new m(y&&!y[0]?-1/0:1!=g.s?NaN:y?0:g);if(null==e?(h=!1,l=b):l=e,m.precision=l+=10,s=(r=M(y)).charAt(0),!(Math.abs(i=g.e)<15e14))return p=C(m,l+2,b).times(i+""),g=J(new m(s+"."+r.slice(1)),l-10).plus(p),m.precision=b,null==e?T(g,b,O,h=!0):g;for(;s<7&&1!=s||1==s&&r.charAt(1)>3;)s=(r=M((g=g.times(t)).d)).charAt(0),f++;for(i=g.e,s>1?(g=new m("0."+r),i++):g=new m(s+"."+r.slice(1)),c=g,u=a=g=H(g.minus(1),g.plus(1),l,1),d=T(g.times(g),l,1),n=3;;){if(a=T(a.times(d),l,1),M((p=u.plus(H(a,new m(n),l,1))).d).slice(0,l)===M(u.d).slice(0,l)){if(u=u.times(2),0!==i&&(u=u.plus(C(m,l+2,b).times(i+""))),u=H(u,new m(f),l,1),null!=e)return m.precision=b,u;if(!E(u.d,l-10,O,o))return T(u,m.precision=b,O,h=!0);m.precision=l+=10,p=a=g=H(c.minus(1),c.plus(1),l,1),d=T(g.times(g),l,1),n=o=1}u=p,n+=2}}function U(t){return String(t.s*t.s/0)}function _(t,e){var r,s,n;for((r=e.indexOf("."))>-1&&(e=e.replace(".","")),(s=e.search(/e/i))>0?(r<0&&(r=s),r+=+e.slice(s+1),e=e.substring(0,s)):r<0&&(r=e.length),s=0;48===e.charCodeAt(s);s++);for(n=e.length;48===e.charCodeAt(n-1);--n);if(e=e.slice(s,n)){if(n-=s,t.e=r=r-s-1,t.d=[],s=(r+1)%7,r<0&&(s+=7),s<n){for(s&&t.d.push(+e.slice(0,s)),n-=7;s<n;)t.d.push(+e.slice(s,s+=7));s=7-(e=e.slice(s)).length}else s-=n;for(;s--;)e+="0";t.d.push(+e),h&&(t.e>t.constructor.maxE?(t.d=null,t.e=NaN):t.e<t.constructor.minE&&(t.e=0,t.d=[0]))}else t.e=0,t.d=[0];return t}function z(t,e){var s,n,i,a,o,u,p,l,c;if(e.indexOf("_")>-1){if(e=e.replace(/(\d)_(?=\d)/g,"$1"),I.test(e))return _(t,e)}else if("Infinity"===e||"NaN"===e)return+e||(t.s=NaN),t.e=NaN,t.d=null,t;if(N.test(e))s=16,e=e.toLowerCase();else if(w.test(e))s=2;else{if(!S.test(e))throw Error(f+e);s=8}for((a=e.search(/p/i))>0?(p=+e.slice(a+1),e=e.substring(2,a)):e=e.slice(2),o=(a=e.indexOf("."))>=0,n=t.constructor,o&&(a=(u=(e=e.replace(".","")).length)-a,i=k(n,new n(s),a,2*a)),a=c=(l=P(e,s,A)).length-1;0===l[a];--a)l.pop();return a<0?new n(0*t.s):(t.e=$(l,c),t.d=l,h=!1,o&&(t=H(t,i,4*u)),p&&(t=t.times(Math.abs(p)<54?b(2,p):r.pow(2,p))),h=!0,t)}function Z(t,e,r,s,n){var i,a,o,u,p=t.precision,l=Math.ceil(p/7);for(h=!1,u=r.times(r),o=new t(s);;){if(a=H(o.times(u),new t(e++*e++),p,1),o=n?s.plus(a):s.minus(a),s=H(a.times(u),new t(e++*e++),p,1),void 0!==(a=o.plus(s)).d[l]){for(i=l;a.d[i]===o.d[i]&&i--;);if(-1==i)break}i=o,o=s,s=a,a=i}return h=!0,a.d.length=l+1,a}function G(t,e){for(var r=t;--e;)r*=t;return r}function Q(t,e){var r,s=e.s<0,n=L(t,t.precision,1),a=n.times(.5);if((e=e.abs()).lte(a))return i=s?4:1,e;if((r=e.divToInt(n)).isZero())i=s?3:2;else{if((e=e.minus(r.times(n))).lte(a))return i=W(r)?s?2:3:s?4:1,e;i=W(r)?s?1:4:s?3:2}return e.minus(n).abs()}function K(t,e,r,n){var i,a,p,l,c,h,d,f,g,y=t.constructor,m=void 0!==r;if(m?(D(r,1,o),void 0===n?n=y.rounding:D(n,0,8)):(r=y.precision,n=y.rounding),t.isFinite()){for(m?(i=2,16==e?r=4*r-3:8==e&&(r=3*r-2)):i=e,(p=(d=V(t)).indexOf("."))>=0&&(d=d.replace(".",""),(g=new y(1)).e=d.length-p,g.d=P(V(g),10,i),g.e=g.d.length),a=c=(f=P(d,10,i)).length;0==f[--c];)f.pop();if(f[0]){if(p<0?a--:((t=new y(t)).d=f,t.e=a,f=(t=H(t,g,r,n,0,i)).d,a=t.e,h=s),p=f[r],l=i/2,h=h||void 0!==f[r+1],h=n<4?(void 0!==p||h)&&(0===n||n===(t.s<0?3:2)):p>l||p===l&&(4===n||h||6===n&&1&f[r-1]||n===(t.s<0?8:7)),f.length=r,h)for(;++f[--r]>i-1;)f[r]=0,r||(++a,f.unshift(1));for(c=f.length;!f[c-1];--c);for(p=0,d="";p<c;p++)d+=u.charAt(f[p]);if(m){if(c>1)if(16==e||8==e){for(p=16==e?4:3,--c;c%p;c++)d+="0";for(c=(f=P(d,i,e)).length;!f[c-1];--c);for(p=1,d="1.";p<c;p++)d+=u.charAt(f[p])}else d=d.charAt(0)+"."+d.slice(1);d=d+(a<0?"p":"p+")+a}else if(a<0){for(;++a;)d="0"+d;d="0."+d}else if(++a>c)for(a-=c;a--;)d+="0";else a<c&&(d=d.slice(0,a)+"."+d.slice(a))}else d=m?"0p+0":"0";d=(16==e?"0x":2==e?"0b":8==e?"0o":"")+d}else d=U(t);return t.s<0?"-"+d:d}function X(t,e){if(t.length>e)return t.length=e,!0}function Y(t){return new this(t).abs()}function tt(t){return new this(t).acos()}function et(t){return new this(t).acosh()}function rt(t,e){return new this(t).plus(e)}function st(t){return new this(t).asin()}function nt(t){return new this(t).asinh()}function it(t){return new this(t).atan()}function at(t){return new this(t).atanh()}function ot(t,e){t=new this(t),e=new this(e);var r,s=this.precision,n=this.rounding,i=s+4;return t.s&&e.s?t.d||e.d?!e.d||t.isZero()?(r=e.s<0?L(this,s,n):new this(0)).s=t.s:!t.d||e.isZero()?(r=L(this,i,1).times(.5)).s=t.s:e.s<0?(this.precision=i,this.rounding=1,r=this.atan(H(t,e,i,1)),e=L(this,i,1),this.precision=s,this.rounding=n,r=t.s<0?r.minus(e):r.plus(e)):r=this.atan(H(t,e,i,1)):(r=L(this,i,1).times(e.s>0?.25:.75)).s=t.s:r=new this(NaN),r}function ut(t){return new this(t).cbrt()}function pt(t){return T(t=new this(t),t.e+1,2)}function lt(t,e,r){return new this(t).clamp(e,r)}function ct(t){if(!t||"object"!=typeof t)throw Error(d+"Object expected");var e,r,s,n=!0===t.defaults,i=["precision",1,o,"rounding",0,8,"toExpNeg",-a,0,"toExpPos",0,a,"maxE",0,a,"minE",-a,0,"modulo",0,9];for(e=0;e<i.length;e+=3)if(r=i[e],n&&(this[r]=c[r]),void 0!==(s=t[r])){if(!(O(s)===s&&s>=i[e+1]&&s<=i[e+2]))throw Error(f+r+": "+s);this[r]=s}if(r="crypto",n&&(this[r]=c[r]),void 0!==(s=t[r])){if(!0!==s&&!1!==s&&0!==s&&1!==s)throw Error(f+r+": "+s);if(s){if("undefined"==typeof crypto||!crypto||!crypto.getRandomValues&&!crypto.randomBytes)throw Error(y);this[r]=!0}else this[r]=!1}return this}function ht(t){return new this(t).cos()}function dt(t){return new this(t).cosh()}function ft(t,e){return new this(t).div(e)}function gt(t){return new this(t).exp()}function yt(t){return T(t=new this(t),t.e+1,3)}function mt(){var t,e,r=new this(0);for(h=!1,t=0;t<arguments.length;)if((e=new this(arguments[t++])).d)r.d&&(r=r.plus(e.times(e)));else{if(e.s)return h=!0,new this(1/0);r=e}return h=!0,r.sqrt()}function Ot(t){return t instanceof r||t&&t.toStringTag===m||!1}function bt(t){return new this(t).ln()}function wt(t,e){return new this(t).log(e)}function Nt(t){return new this(t).log(2)}function St(t){return new this(t).log(10)}function It(){return q(this,arguments,"lt")}function At(){return q(this,arguments,"gt")}function jt(t,e){return new this(t).mod(e)}function vt(t,e){return new this(t).mul(e)}function xt(t,e){return new this(t).pow(e)}function Mt(t){var e,r,s,n,i=0,a=new this(1),u=[];if(void 0===t?t=this.precision:D(t,1,o),s=Math.ceil(t/7),this.crypto)if(crypto.getRandomValues)for(e=crypto.getRandomValues(new Uint32Array(s));i<s;)(n=e[i])>=429e7?e[i]=crypto.getRandomValues(new Uint32Array(1))[0]:u[i++]=n%1e7;else{if(!crypto.randomBytes)throw Error(y);for(e=crypto.randomBytes(s*=4);i<s;)(n=e[i]+(e[i+1]<<8)+(e[i+2]<<16)+((127&e[i+3])<<24))>=214e7?crypto.randomBytes(4).copy(e,i):(u.push(n%1e7),i+=4);i=s/4}else for(;i<s;)u[i++]=1e7*Math.random()|0;for(t%=7,(s=u[--i])&&t&&(n=b(10,7-t),u[i]=(s/n|0)*n);0===u[i];i--)u.pop();if(i<0)r=0,u=[0];else{for(r=-1;0===u[0];r-=7)u.shift();for(s=1,n=u[0];n>=10;n/=10)s++;s<7&&(r-=7-s)}return a.e=r,a.d=u,a}function Dt(t){return T(t=new this(t),t.e+1,this.rounding)}function Et(t){return(t=new this(t)).d?t.d[0]?t.s:0*t.s:t.s||NaN}function Pt(t){return new this(t).sin()}function Ht(t){return new this(t).sinh()}function Tt(t){return new this(t).sqrt()}function Vt(t,e){return new this(t).sub(e)}function $t(){var t=0,e=arguments,r=new this(e[t]);for(h=!1;r.s&&++t<e.length;)r=r.plus(e[t]);return h=!0,T(r,this.precision,this.rounding)}function Ct(t){return new this(t).tan()}function Lt(t){return new this(t).tanh()}function Bt(t){return T(t=new this(t),t.e+1,1)}r=function t(e){var r,s,n;function i(t){var e,r,s,n=this;if(!(n instanceof i))return new i(t);if(n.constructor=i,Ot(t))return n.s=t.s,void(h?!t.d||t.e>i.maxE?(n.e=NaN,n.d=null):t.e<i.minE?(n.e=0,n.d=[0]):(n.e=t.e,n.d=t.d.slice()):(n.e=t.e,n.d=t.d?t.d.slice():t.d));if("number"===(s=typeof t)){if(0===t)return n.s=1/t<0?-1:1,n.e=0,void(n.d=[0]);if(t<0?(t=-t,n.s=-1):n.s=1,t===~~t&&t<1e7){for(e=0,r=t;r>=10;r/=10)e++;return void(h?e>i.maxE?(n.e=NaN,n.d=null):e<i.minE?(n.e=0,n.d=[0]):(n.e=e,n.d=[t]):(n.e=e,n.d=[t]))}return 0*t!=0?(t||(n.s=NaN),n.e=NaN,void(n.d=null)):_(n,t.toString())}if("string"!==s)throw Error(f+t);return 45===(r=t.charCodeAt(0))?(t=t.slice(1),n.s=-1):(43===r&&(t=t.slice(1)),n.s=1),I.test(t)?_(n,t):z(n,t)}if(i.prototype=x,i.ROUND_UP=0,i.ROUND_DOWN=1,i.ROUND_CEIL=2,i.ROUND_FLOOR=3,i.ROUND_HALF_UP=4,i.ROUND_HALF_DOWN=5,i.ROUND_HALF_EVEN=6,i.ROUND_HALF_CEIL=7,i.ROUND_HALF_FLOOR=8,i.EUCLID=9,i.config=i.set=ct,i.clone=t,i.isDecimal=Ot,i.abs=Y,i.acos=tt,i.acosh=et,i.add=rt,i.asin=st,i.asinh=nt,i.atan=it,i.atanh=at,i.atan2=ot,i.cbrt=ut,i.ceil=pt,i.clamp=lt,i.cos=ht,i.cosh=dt,i.div=ft,i.exp=gt,i.floor=yt,i.hypot=mt,i.ln=bt,i.log=wt,i.log10=St,i.log2=Nt,i.max=It,i.min=At,i.mod=jt,i.mul=vt,i.pow=xt,i.random=Mt,i.round=Dt,i.sign=Et,i.sin=Pt,i.sinh=Ht,i.sqrt=Tt,i.sub=Vt,i.sum=$t,i.tan=Ct,i.tanh=Lt,i.trunc=Bt,void 0===e&&(e={}),e&&!0!==e.defaults)for(n=["precision","rounding","toExpNeg","toExpPos","maxE","minE","modulo","crypto"],r=0;r<n.length;)e.hasOwnProperty(s=n[r++])||(e[s]=this[s]);return i.config(e),i}(c),r.prototype.constructor=r,r.default=r.Decimal=r,p=new r(p),l=new r(l),void 0!==e&&e.exports?("function"==typeof Symbol&&"symbol"==typeof Symbol.iterator&&(x[Symbol.for("nodejs.util.inspect.custom")]=x.toString,x[Symbol.toStringTag]="Decimal"),e.exports=r):(t||(t="undefined"!=typeof self&&self&&self.self==self?self:window),n=t.Decimal,r.noConflict=function(){return t.Decimal=n,r},t.Decimal=r)}(this)},{}],2:[function(t,e,r){e.exports=
/**
* @license MIT
...
* @author <steven@velozo.com>
*/
var s=t("./Manyfest.js");"object"==typeof window&&(window.Manyfest=s),e.exports=s},{"./Manyfest.js":41}],36:[function(t,e,r){arguments[4][26][0].apply(r,arguments)},{"./Manyfest-LogToConsole.js":37,dup:26}],37:[function(t,e,r){arguments[4][27][0].apply(r,arguments)},{dup:27}],38:[function(t,e,r){arguments[4][28][0].apply(r,arguments)},{"./Manyfest-LogToConsole.js":37,dup:28}],39:[function(t,e,r){
/**
* @license MIT
* @author <steven@velozo.com>
*/
let s=t("./Manyfest-LogToConsole.js"),n=t("precedent");e.exports=class{constructor(t,e){this.logInfo="function"==typeof t?t:s,this.logError="function"==typeof e?e:s,this.elucidatorSolver=!1,this.elucidatorSolverState={}}cleanWrapCharacters(t,e){return e.startsWith(t)&&e.endsWith(t)?e.substring(1,e.length-1):e}checkAddressExists(t,e){if("object"!=typeof t)return!1;if("string"!=typeof e)return!1;let r=e.indexOf(".");if(-1==r){let r=e.indexOf("["),s=e.indexOf("]");if(r>0&&s>r&&s-r>1){let n=e.substring(0,r).trim();if("object"!=typeof t[n])return!1;let i=e.substring(r+1,s).trim(),a=parseInt(i,10);return Array.isArray(t[n])!=isNaN(a)&&(isNaN(a)?(i=this.cleanWrapCharacters('"',i),i=this.cleanWrapCharacters("`",i),i=this.cleanWrapCharacters("'",i),t[n].hasOwnProperty(i)):a in t[n])}return t.hasOwnProperty(e)}{let s=e.substring(0,r),n=e.substring(r+1),i=s.indexOf("["),a=s.indexOf("]");if(i>0&&a>i&&a-i>1){let e=s.substring(0,i).trim(),r=s.substring(i+1,a).trim(),o=parseInt(r,10);return Array.isArray(t[e])!=isNaN(o)&&(isNaN(o)?(r=this.cleanWrapCharacters('"',r),r=this.cleanWrapCharacters("`",r),r=this.cleanWrapCharacters("'",r),this.checkAddressExists(t[e][r],n)):this.checkAddressExists(t[e][o],n))}return(!t.hasOwnProperty(s)||"object"==typeof t[s])&&(t.hasOwnProperty(s)||(t[s]={}),this.checkAddressExists(t[s],n))}}checkFilters(e,r){let s=new n,i=e;if(!this.elucidatorSolver){let e=t("elucidator");this.elucidatorSolver=new e({},this.logInfo,this.logError)}if(this.elucidatorSolver){let t={Record:r,keepRecord:!0};return s.addPattern("<<~~","~~>>",(e=>{this.elucidatorSolverState.hasOwnProperty(e)&&(t.SolutionState=this.elucidatorSolverState[e]),this.elucidatorSolver.solveInternalOperation("Custom",e,t)})),s.addPattern("<<~?","?~>>",(e=>{if("string"!=typeof e)return!1;let r=e.split(","),s=r[0],n=r[1],i=r[2];t.ComparisonState={SearchAddress:s,Comparator:n,SearchTerm:i},this.elucidatorSolver.solveOperation({Description:{Operation:"Simple_If",Synopsis:"Test for "},Steps:[{Namespace:"Logic",Instruction:"if",InputHashAddressMap:{leftValue:`Record.${s}`,rightValue:"ComparisonState.SearchTerm",comparator:"ComparisonState.Comparator"},OutputHashAddressMap:{truthinessResult:"keepRecord"}}]},t)})),s.parseString(i),t.keepRecord}return!0}getValueAtAddress(t,e,r){if("object"!=typeof t)return;if("string"!=typeof e)return;let s="";"string"==typeof r&&(s=r);let n=e.indexOf(".");if(-1==n){let r=e.indexOf("["),s=e.indexOf("]"),n=e.indexOf("{}");if(r>0&&s>r&&s-r>1){let n=e.substring(0,r).trim();if("object"!=typeof t[n])return;let i=e.substring(r+1,s).trim(),a=parseInt(i,10);if(Array.isArray(t[n])==isNaN(a))return;return isNaN(a)?(i=this.cleanWrapCharacters('"',i),i=this.cleanWrapCharacters("`",i),i=this.cleanWrapCharacters("'",i),t[n][i]):t[n][a]}if(r>0&&s>r&&s-r==1){let s=e.substring(0,r).trim();if(!Array.isArray(t[s]))return!1;let n=t[s],i=[];for(let t=0;t<n.length;t++){this.checkFilters(e,n[t])&&i.push(n[t])}return i}if(n>0){let r=e.substring(0,n).trim();return"object"==typeof t[r]&&t[r]}return t[e]}{let r=e.substring(0,n),i=e.substring(n+1),a=r.indexOf("["),o=r.indexOf("]");if(a>0&&o>a&&o-a>1){let e=r.substring(0,a).trim(),n=r.substring(a+1,o).trim(),u=parseInt(n,10);if(Array.isArray(t[e])==isNaN(u))return;return isNaN(u)?(n=this.cleanWrapCharacters('"',n),n=this.cleanWrapCharacters("`",n),n=this.cleanWrapCharacters("'",n),s=`${s}${s.length>0?".":""}${r}`,this.getValueAtAddress(t[e][n],i,s)):(s=`${s}${s.length>0?".":""}${r}`,this.getValueAtAddress(t[e][u],i,s))}if(a>0&&o>a&&o-a==1){let r=e.substring(0,a).trim();if(!Array.isArray(t[r]))return!1;let n=t[r];s=`${s}${s.length>0?".":""}${r}`;let o={};for(let e=0;e<n.length;e++){let n=`${s}[${e}]`,a=this.getValueAtAddress(t[r][e],i,n);o[`${n}.${i}`]=a}return o}let u=e.indexOf("{}");if(u>0){let r=e.substring(0,u).trim();if("object"!=typeof t[r])return!1;let n=t[r],a=Object.keys(n);s=`${s}${s.length>0?".":""}${r}`;let o={};for(let n=0;n<a.length;n++){let u=`${s}.${a[n]}`,p=this.getValueAtAddress(t[r][a[n]],i,u);this.checkFilters(e,p)&&(o[`${u}.${i}`]=p)}return o}return t.hasOwnProperty(r)&&"object"!=typeof t[r]?void 0:t.hasOwnProperty(r)?(s=`${s}${s.length>0?".":""}${r}`,this.getValueAtAddress(t[r],i,s)):(s=`${s}${s.length>0?".":""}${r}`,t[r]={},this.getValueAtAddress(t[r],i,s))}}setValueAtAddress(t,e,r){if("object"!=typeof t)return!1;if("string"!=typeof e)return!1;let s=e.indexOf(".");if(-1==s){let s=e.indexOf("["),n=e.indexOf("]");if(s>0&&n>s&&n-s>1){let i=e.substring(0,s).trim();if("object"!=typeof t[i])return!1;let a=e.substring(s+1,n).trim(),o=parseInt(a,10);return Array.isArray(t[i])!=isNaN(o)&&(isNaN(o)?(a=this.cleanWrapCharacters('"',a),a=this.cleanWrapCharacters("`",a),a=this.cleanWrapCharacters("'",a),t[i][a]=r,!0):(t[i][o]=r,!0))}return t[e]=r,!0}{let n=e.substring(0,s),i=e.substring(s+1),a=n.indexOf("["),o=n.indexOf("]");if(a>0&&o>a&&o-a>1){let e=n.substring(0,a).trim(),s=n.substring(a+1,o).trim(),u=parseInt(s,10);return Array.isArray(t[e])!=isNaN(u)&&(isNaN(u)?(s=this.cleanWrapCharacters('"',s),s=this.cleanWrapCharacters("`",s),s=this.cleanWrapCharacters("'",s),this.setValueAtAddress(t[e][s],i,r)):this.setValueAtAddress(t[e][u],i,r))}return t.hasOwnProperty(n)&&"object"!=typeof t[n]?(t.hasOwnProperty("__ERROR")||(t.__ERROR={}),t.__ERROR[e]=r,!1):(t.hasOwnProperty(n)||(t[n]={}),this.setValueAtAddress(t[n],i,r))}}}},{"./Manyfest-LogToConsole.js":37,elucidator:25,precedent:32}],40:[function(t,e,r){arguments[4][30][0].apply(r,arguments)},{"./Manyfest-LogToConsole.js":37,dup:30}],41:[function(t,e,r){
/**
* @license MIT
* @author <steven@velozo.com>
*/
let s=t("./Manyfest-LogToConsole.js"),n=(t("precedent"),t("./Manyfest-HashTranslation.js")),i=t("./Manyfest-ObjectAddressResolver.js"),a=t("./Manyfest-ObjectAddressGeneration.js"),o=t("./Manyfest-SchemaManipulation.js");class u{constructor(t,e,r,u){this.logInfo="function"==typeof e?e:s,this.logError="function"==typeof r?r:s,this.objectAddressResolver=new i(this.logInfo,this.logError),this.options={strict:!1,defaultValues:{String:"",Number:0,Float:0,Integer:0,Boolean:!1,Binary:0,DateTime:0,Array:[],Object:{},Null:null}},this.scope=void 0,this.elementAddresses=void 0,this.elementHashes=void 0,this.elementDescriptors=void 0,this.dataSolvers=void 0,this.dataSolverState=void 0,this.reset(),"object"==typeof t&&this.loadManifest(t),this.schemaManipulations=new o(this.logInfo,this.logError),this.objectAddressGeneration=new a(this.logInfo,this.logError),this.hashTranslations=new n(this.logInfo,this.logError)}reset(){this.scope="DEFAULT",this.elementAddresses=[],this.elementHashes={},this.elementDescriptors={},this.dataSolvers=void 0,this.dataSolverState={},this.libElucidator=void 0,this.objectAddressResolver.elucidatorSolver=!1}clone(){let t=JSON.parse(JSON.stringify(this.options)),e=new u(this.getManifest(),this.logInfo,this.logError,t);return e.hashTranslations.addTranslation(this.hashTranslations.translationTable),e}deserialize(t){return this.loadManifest(JSON.parse(t))}loadManifest(e){if("object"!=typeof e)return this.logError(`(${this.scope}) Error loading manifest; expecting an object but parameter was type ${typeof e}.`),!1;if(e.hasOwnProperty("Scope")?"string"==typeof e.Scope?this.scope=e.Scope:this.logError(`(${this.scope}) Error loading scope from manifest; expecting a string but property was type ${typeof e.Scope}.`,e):this.logError(`(${this.scope}) Error loading scope from manifest object.  Property "Scope" does not exist in the root of the object.`,e),e.hasOwnProperty("Descriptors"))if("object"==typeof e.Descriptors){let t=Object.keys(e.Descriptors);for(let r=0;r<t.length;r++)this.addDescriptor(t[r],e.Descriptors[t[r]])}else this.logError(`(${this.scope}) Error loading description object from manifest object.  Expecting an object in 'Manifest.Descriptors' but the property was type ${typeof e.Descriptors}.`,e);else this.logError(`(${this.scope}) Error loading object description from manifest object.  Property "Descriptors" does not exist in the root of the Manifest object.`,e);if(e.hasOwnProperty("Solvers")&&"object"==typeof e.Solvers){let r=t("elucidator");this.dataSolvers=new r(e.Solvers,this.logInfo,this.logError),this.objectAddressResolver.elucidatorSolver=this.dataSolvers;let s=Object.keys(e.Solvers);for(let t=0;t<s.length;t++)this.dataSolverState[s]=e.Solvers[s[t]];this.objectAddressResolver.elucidatorSolverState=this.dataSolverState}}serialize(){return JSON.stringify(this.getManifest())}getManifest(){return{Scope:this.scope,Descriptors:JSON.parse(JSON.stringify(this.elementDescriptors))}}addDescriptor(t,e){return"object"==typeof e?(e.hasOwnProperty("Address")||(e.Address=t),this.elementDescriptors.hasOwnProperty(t)||this.elementAddresses.push(t),this.elementDescriptors[t]=e,this.elementHashes[t]=t,e.hasOwnProperty("Hash")?this.elementHashes[e.Hash]=t:e.Hash=t,!0):(this.logError(`(${this.scope}) Error loading object descriptor for address '${t}' from manifest object.  Expecting an object but property was type ${typeof e}.`),!1)}getDescriptorByHash(t){return this.getDescriptor(this.resolveHashAddress(t))}getDescriptor(t){return this.elementDescriptors[t]}eachDescriptor(t){let e=Object.keys(this.elementDescriptors);for(let r=0;r<e.length;r++)t(this.elementDescriptors[e[r]])}checkAddressExistsByHash(t,e){return this.checkAddressExists(t,this.resolveHashAddress(e))}checkAddressExists(t,e){return this.objectAddressResolver.checkAddressExists(t,e)}resolveHashAddress(t){let e,r=this.elementHashes.hasOwnProperty(t),s=this.hashTranslations.translationTable.hasOwnProperty(t);return e=r&&!s?this.elementHashes[t]:s&&this.elementHashes.hasOwnProperty(this.hashTranslations.translate(t))?this.elementHashes[this.hashTranslations.translate(t)]:s?this.hashTranslations.translate(t):t,e}getValueByHash(t,e){let r=this.getValueAtAddress(t,this.resolveHashAddress(e));return void 0===r&&(r=this.getDefaultValue(this.getDescriptorByHash(e))),r}getValueAtAddress(t,e){let r=this.objectAddressResolver.getValueAtAddress(t,e);return void 0===r&&(r=this.getDefaultValue(this.getDescriptor(e))),r}setValueByHash(t,e,r){return this.setValueAtAddress(t,this.resolveHashAddress(e),r)}setValueAtAddress(t,e,r){return this.objectAddressResolver.setValueAtAddress(t,e,r)}validate(t){let e={Error:null,Errors:[],MissingElements:[]};"object"!=typeof t&&(e.Error=!0,e.Errors.push("Expected passed in object to be type object but was passed in "+typeof t));let r=(t,r)=>{e.Error=!0,e.Errors.push(`Element at address "${t}" ${r}.`)};for(let s=0;s<this.elementAddresses.length;s++){let n=this.getDescriptor(this.elementAddresses[s]),i=this.checkAddressExists(t,n.Address),a=this.getValueAtAddress(t,n.Address);if(void 0!==a&&i||(e.MissingElements.push(n.Address),(n.Required||this.options.strict)&&r(n.Address,"is flagged REQUIRED but is not set in the object")),n.DataType){let t=typeof a;switch(n.DataType.toString().trim().toLowerCase()){case"string":"string"!=t&&r(n.Address,`has a DataType ${n.DataType} but is of the type ${t}`);break;case"number":"number"!=t&&r(n.Address,`has a DataType ${n.DataType} but is of the type ${t}`);break;case"integer":if("number"!=t)r(n.Address,`has a DataType ${n.DataType} but is of the type ${t}`);else{a.toString().indexOf(".")>-1&&r(n.Address,`has a DataType ${n.DataType} but has a decimal point in the number.`)}break;case"float":"number"!=t&&r(n.Address,`has a DataType ${n.DataType} but is of the type ${t}`);break;case"DateTime":"Invalid Date"==new Date(a).toString()&&r(n.Address,`has a DataType ${n.DataType} but is not parsable as a Date by Javascript`);default:"string"!=t&&r(n.Address,`has a DataType ${n.DataType} (which auto-converted to String because it was unrecognized) but is of the type ${t}`)}}}return e}getDefaultValue(t){if("object"==typeof t){if(t.hasOwnProperty("Default"))return t.Default;{let e=t.hasOwnProperty("DataType")?t.DataType:"String";return this.options.defaultValues.hasOwnProperty(e)?this.options.defaultValues[e]:null}}}populateDefaults(t,e){return this.populateObject(t,e,(t=>t.hasOwnProperty("Default")))}populateObject(t,e,r){let s="object"==typeof t?t:{},n=void 0!==e&&e,i="function"==typeof r?r:t=>!0;return this.elementAddresses.forEach((t=>{let e=this.getDescriptor(t);i(e)&&(!n&&this.checkAddressExists(s,t)||this.setValueAtAddress(s,t,this.getDefaultValue(e)))})),s}}e.exports=u},{"./Manyfest-HashTranslation.js":36,"./Manyfest-LogToConsole.js":37,"./Manyfest-ObjectAddressGeneration.js":38,"./Manyfest-ObjectAddressResolver.js":39,"./Manyfest-SchemaManipulation.js":40,elucidator:25,precedent:32}]},{},[35])(35)}));
